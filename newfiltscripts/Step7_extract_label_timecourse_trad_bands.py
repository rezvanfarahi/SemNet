...
this_pathto=out_path+b+'_newfilt_wbw_ROItcs_normal_meanflip_ROI_ATAGIFGMTGVISHRHN_evVisHrHn.mat'#'DKA68_orig_modified_coh.mat'#lh.fsaverage_finalpostparc_smooth_split_merge.annot            
...
#conno1=0
#conno2=1
tlowlim=np.arange(350,751,10)
thilim=np.arange(375,776,10)
for roino in roinos:
    print roino
    for conno1 in connos1:
        ...
        for conno2 in np.setdiff1d(np.asarray(connos2),np.asarray([conno1])):
            ...
            #Xall=np.zeros(n_subjects,16,21)
