...
##       figname_out='/imaging/rf02/Semnet/results/evoked/'+b+'_noisecov_filtnew/subj'+str(subject)+'_evoked-ave.fif'#.jpg
##       evoked.save(figname_out)
#
#       figname_out='/imaging/rf02/Semnet/results/evoked/'+b+'_noisecov_filtnew/whitened_subj'+str(subject)+'.jpg'#.jpg
