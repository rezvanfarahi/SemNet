...
###############################################################################
# Set parameters
out_path = '/imaging/rf02/Semnet/stc/permutation/evoked/pnt1_48/newregsigned/allwpw/' # root
uvttest_path = '/imaging/rf02/Semnet/stc/uvttest/evoked/pnt1_48/newregsigned/allwpw/' # root
avg_path= '/imaging/rf02/Semnet/stc/GrandAverage/evoked/pnt1_48/newregsigned/allwpw/'
...
#    n_permutations=5000
    for condavg in range(n_levels):
        ...
        out_file4=avg_path + 'Grandavg_icomorphed_newreg_19subj_SemDec_m300_600_25ms_pnt1_48ica_'+event_names[condavg]#+'_'+b
...
#        refcond=thiscond+1
        ...
        out_file3=uvttest_path + 'UVTtest_icomorphed_newreg_19subj_SemDec_m300_600_25ms_pnt1_48ica_'+event_names[thiscond]+'_'+event_names[refcond]#+'_'+b
...
#        print cluster_p_values.min()
        ...
        if len(cluster_p_values)>0:
            if cluster_p_values.min()<0.05:
                ...
                out_file1=out_path + 'ClusPer_abs_icomorphed_newreg_clusterp'+str(p_threshold)[2:]+'_p'+str(p_thr)[2:]+'_19subj_SemDec_pnt1_48ica_'+event_names[thiscond]+'_'+event_names[refcond]+'_maxstep'+str(max_step)
                ...
                out_file2=out_path + 'ClusPer_abs_sw_icomorphed_newreg_clusterp'+str(p_threshold)[2:]+'_p'+str(p_thr)[2:]+'_19subj_SemDec_pnt1_48ica_'+event_names[thiscond]+'_'+event_names[refcond]+'_maxstep'+str(max_step)
