...
uvttest_path = '/imaging/rf02/Semnet/stc/uvttest/evoked/bands/newfilt/newregsigned/taugamma_newev/19subs/' # root
avg_path = '/imaging/rf02/Semnet/stc/GrandAverage/evoked/bands/newfilt/newregsigned/taugamma_newev/19subs/'
...
#            X[ii,:,:,event_no]=np.transpose(stc_cond.data,[1,0])
    ...
    out_file2=uvttest_path + 'UVttest_sEvoked_icomorphed_newreg_20subj_SemDec_pnt1_30ica_'+event_names[0]+'_'+event_names[1]+'_gammamu'
    ...
    out_file3=uvttest_path + 'UVttest_Alpha_sEvoked_icomorphed_newreg_20subj_SemDec_pnt1_30ica_'+event_names[0]+'_'+event_names[1]
    ...
    out_file3=uvttest_path + 'UVttest_Gamma_sEvoked_icomorphed_newreg_20subj_SemDec_pnt1_30ica_'+event_names[0]+'_'+event_names[1]
    tval_stc.save(out_file3)
    ...
    out_file3=avg_path + 'Grandavg_Alpha_sEvoked_icomorphed_newreg_20subj_SemDec_pnt1_30ica_'+event_names[0]+'_'+event_names[1]
    ...
    out_file3=avg_path + 'Grandavg_Gamma_sEvoked_icomorphed_newreg_20subj_SemDec_pnt1_30ica_'+event_names[0]+'_'+event_names[1]
    avg_stc.save(out_file3)
