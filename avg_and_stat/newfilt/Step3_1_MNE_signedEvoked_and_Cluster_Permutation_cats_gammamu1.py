...
out_path = '/imaging/rf02/Semnet/stc/permutation/evoked/bands/newfilt/newregsigned/mugamma_newev/nsubs_'+str(nsubs)+'/' # root
uvttest_path = '/imaging/rf02/Semnet/stc/uvttest/evoked/bands/newfilt/newregsigned/mugamma_newev/nsubs_'+str(nsubs)+'/' # root
...
#        print cluster_p_values.min()
    ...
    if len(cluster_p_values)>0:
        if cluster_p_values.min()<0.05:
            ...
            out_file1=out_path + 'ClusPer_sEvoked_icomorphed_newreg_clusterp'+str(p_threshold)[2:]+'_p'+str(p_thr)[2:]+'_20subj_SemDec_pnt1_30ica_'+event_names[0]+'_'+event_names[1]+'gammamu_maxstep'+str(max_step)
            ...
            out_file2=out_path + 'ClusPer_sEvoked_sw_icomorphed_newreg_clusterp'+str(p_threshold)[2:]+'_p'+str(p_thr)[2:]+'_20subj_SemDec_pnt1_30ica_'+event_names[0]+'_'+event_names[1]+'gammamu_maxstep'+str(max_step)
