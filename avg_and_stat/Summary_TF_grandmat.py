    ...
    for meg in list_all:
        ...
        for bcnt,b in enumerate(bands):
            ...
            for eventc, this_event in enumerate(event_names):    
                print this_event
                fname_even = data_path + meg + 'mineMorphed_bandnoisecov_ico_SemDec_ica_'+this_event+'_Power_Even_normori_ratio_equalized_m500_700_200hz_' + b#'mineMorphed_ico_TypLex_icaclean_word_Power_ratio_equalized_m500_700_' + b
                stc_even = mne.read_source_estimate(fname_even)
                Xe[:,:,bcnt,eventc,ii]=stc_even.data
                fname_odd = data_path + meg + 'mineMorphed_bandnoisecov_ico_SemDec_ica_'+this_event+'_Power_Odd_normori_ratio_equalized_m500_700_200hz_' + b#'mineMorphed_ico_TypLex_icaclean_word_Power_ratio_equalized_m500_700_' + b
