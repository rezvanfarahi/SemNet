...
for p_threshold in ll:
    ...
    for ii, meg in enumerate(list_all):
        ...
        for event_no in range(n_levels):     
            fname_in = data_path + meg + 'firstMorphed_ico_oldreg_SemDec_pnt1_30ica_'+event_names[event_no]+'_Source_Evoked_m300_600'#_'+b#'firstMorphed_ico_SemDec_ica_'+event_names[event_no]+'_Source_Evoked_mnrsmpl_50_550_100ms_0ov'#'_Source_Evoked_m300_600'#'_Source_Evoked_mnrsmpl_50_550_100ms_0ov'
...
#            return f_mway_rm(xx2, factor_levels=factor_levels,effects=effects, return_pvals=False)[0]
    ...
    for thiscond in np.array([0]):#in range(5):
        ...
        out_file3=uvttest_path + 'UVTtest_icomorphed_oldreg_19subj_SemDec_m300_600_100ms_pnt1_30ica_'+event_names[thiscond]+'_'+event_names[refcond]#+'_'+b
