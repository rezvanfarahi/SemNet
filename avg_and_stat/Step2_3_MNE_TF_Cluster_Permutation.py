...
out_path = '/imaging/rf02/TypLexMEG/icaanalysis_results/stc/permutation/power/final_allbands/abs/' #
...
Xc=np.zeros((nverts,ntimes,nbands,nevents,nsubjs))
...
#    scio.savemat(path_mtx,{'Xa':Xa})     
    ...
    X = np.subtract(np.abs(Xcf-1),np.abs(Xaf-1))
