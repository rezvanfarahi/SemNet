...
###############################################################################
out_path = '/imaging/rf02/Semnet/stc/GrandAverage/evoked/oldreg/' # root directory for your MEG data
...
for event_no in range(len(event_names)):
    ...
    for ii, meg in enumerate(ll):
        print ii
        fname = data_path + meg + 'firstMorphed_ico_oldreg_SemDec_pnt1_30ica_'+event_names[event_no]+'_Source_Evoked_m300_600'  
        ...
        out_file0=data_path + meg + 'firstMorphed_ico_oldreg_SemDec_pnt1_30ica_'+event_names[event_no]+'_Source_Evoked_mnrsmpl_50_550_100ms_0ov'
    ...
    out_file=out_path + 'GrandAverage_firstMorphed_ico_oldreg_SemDec_pnt1_30ica_'+event_names[event_no]+'_Source_Evoked_m300_600'
    out_filer=out_path + 'GrandAverage_firstMorphed_ico_oldreg_SemDec_pnt1_30ica_'+event_names[event_no]+'_Source_Evoked_mnrsmpl_50_550_100ms_0ov'
    stc_grandc[event_no].save(out_file)
    stc_grandcr[event_no].save(out_filer)

out_filef=out_path + 'GrandAverage_firstMorphed_ico_oldreg_SemDec_pnt1_30ica_all_Source_Evoked_m300_600'
stc_grand=np.mean(stc_grandc)
stc_grand.save(out_filef)
out_filefr=out_path + 'GrandAverage_firstMorphed_ico_oldreg_SemDec_pnt1_30ica_all_Source_Evoked_mnrsmpl_50_550_100ms_0ov'
stc_grandr=np.mean(stc_grandcr)
stc_grandr.save(out_filefr)

out_file=out_path + 'GrandAverage_firstMorphed_ico_oldreg_SemDec_pnt1_30ica_'+event_names[0]+'_'+event_names[5]+'_Source_Evoked_m300_600'
stc_shp=np.subtract(stc_grandc[0],stc_grandc[5])
stc_shp.save(out_file)

out_file=out_path + 'GrandAverage_firstMorphed_ico_oldreg_SemDec_pnt1_30ica_'+event_names[1]+'_'+event_names[5]+'_Source_Evoked_m300_600'
stc_shp=np.subtract(stc_grandc[1],stc_grandc[5])
stc_shp.save(out_file)

out_file=out_path + 'GrandAverage_firstMorphed_ico_oldreg_SemDec_pnt1_30ica_'+event_names[2]+'_'+event_names[5]+'_Source_Evoked_m300_600'
stc_shp=np.subtract(stc_grandc[2],stc_grandc[5])
stc_shp.save(out_file)

"""
import matplotlib.pyplot as plt
in_file1=out_path + 'GrandAverage_SemDec_pnt1_30icaclean_oldreg_Subtract_SourcePower_ratio_m500_700_theta'  
stc1=mne.read_source_estimate(in_file1)
in_file2=out_path + 'GrandAverage_SemDec_pnt1_30icaclean_oldreg_Subtract_SourcePower_ratio_m500_700_alpha' 
stc2=mne.read_source_estimate(in_file2) 
in_file3=out_path + 'GrandAverage_SemDec_pnt1_30icaclean_oldreg_Subtract_SourcePower_ratio_m500_700_beta'  
stc3=mne.read_source_estimate(in_file3)
in_file4=out_path + 'GrandAverage_SemDec_pnt1_30icaclean_oldreg_Subtract_SourcePower_ratio_m500_700_gamma'  
