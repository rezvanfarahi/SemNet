...
###############################################################################
# Set parameters
out_path = '/imaging/rf02/Semnet/stc/permutation/evoked/pnt1_30/oldreg/' # root
uvttest_path = '/imaging/rf02/Semnet/stc/uvttest/evoked/pnt1_30/oldreg/' # root
...
for p_threshold in ll:
    ...
    for ii, meg in enumerate(list_all):
        ...
        for event_no in range(n_levels):     
            fname_in = data_path + meg + 'firstMorphed_ico_oldreg_SemDec_pnt1_30ica_'+event_names[event_no]+'_Source_Evoked_m300_600'#'firstMorphed_ico_SemDec_pnt1_30ica_'+event_names[event_no]+'_Source_Evoked_mnrsmpl_50_550_100ms_0ov'#'_Source_Evoked_m300_600'#'_Source_Evoked_mnrsmpl_50_550_100ms_0ov'
...
#        refcond=thiscond+1
        ...
        if cluster_p_values.min()<=0.05:
            ...
            out_file1=out_path + 'ClusPer_abs_icomorphed_oldreg_clusterp'+str(p_threshold)[2:]+'_p'+str(p_thr)[2:]+'_19subj_SemDec_pnt1_30ica_'+event_names[thiscond]+'_'+event_names[refcond]+'_maxstep'+str(max_step)
            ...
            out_file2=out_path + 'ClusPer_abs_sw_icomorphed_oldreg_clusterp'+str(p_threshold)[2:]+'_p'+str(p_thr)[2:]+'_19subj_SemDec_pnt1_30ica_'+event_names[thiscond]+'_'+event_names[refcond]+'_maxstep'+str(max_step)
