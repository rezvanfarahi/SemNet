...
uvttest_path = '/imaging/rf02/Semnet/stc/uvttest/evoked/pnt1_30/snrwins/' # root
...
#X_list=range(2)
event_names = ['Visual','Hand', 'Hear','Neutral', 'Emotional','Pwordc']#, ,'Pwordc']
#thiscond=0
refcond=1
...
for p_threshold in ll:
    ...
    for ii, meg in enumerate(list_all):
        ...
        for event_no in range(n_levels):     
            fname_in = data_path + meg + 'firstMorphed_ico_SemDec_pnt1_30ica_'+event_names[event_no]+'_Source_Evoked_m300_600'#'firstMorphed_ico_SemDec_ica_'+event_names[event_no]+'_Source_Evoked_mnrsmpl_50_550_100ms_0ov'#'_Source_Evoked_m300_600'#'_Source_Evoked_mnrsmpl_50_550_100ms_0ov'
...
#            return f_mway_rm(xx2, factor_levels=factor_levels,effects=effects, return_pvals=False)[0]    
    ...
    for thiscond in np.array([0]):#in range(5):
        ...
        out_file3=uvttest_path + 'UVTtest_snrwins_icomorphed_19subj_SemDec_m300_600_100ms_pnt1_30ica_'+event_names[thiscond]+'_'+event_names[refcond]
