...
###############################################################################
# Set parameters
out_path = '/imaging/rf02/Semnet/stc/permutation/evoked/bands/newregsigned/taugamma_newev/' # root
...
#thiscond=3
refcond=0
out_path_img='/imaging/rf02/Semnet/jpg/permutation/evoked/bands/newregsigned/taugamma_newev/'+event_names[thiscond]+'/'
...
#    fname_in=out_path + 'ClusPer_abs_sw_icomorphed_newreg_clusterp'+str(p_threshold)[2:]+'_p'+str(p_thr)[2:]+'_19subj_SemDec_pnt1_30ica_'+event_names[thiscond]+'_'+event_names[refcond]+'_maxstep'+str(max_step)
    fname_in=out_path + 'ClusPer_sEvoked_sw_icomorphed_newreg_clusterp'+str(p_threshold)[2:]+'_p'+str(p_thr)[2:]+'_19subj_SemDec_pnt1_30ica_'+event_names[refcond]+'_'+event_names[thiscond]+'gammamu_maxstep'+str(max_step)
...
for this_t in times_list:
	thisbrain=stc_sum.plot(hemi=hemi, 	views=this_view,subjects_dir=data_path,subject='fsaverage',time_viewer=False,colormap='afmhot',alpha=1,clim=clim,
