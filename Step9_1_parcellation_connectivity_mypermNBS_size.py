# -*- coding: utf-8 -*-
"""
Created on Fri Oct  6 03:31:11 2017
...
#        print uvcnt
    ...
    MTpos_1side=MTpos.copy()#MT.copy()
...
#            print uvcnt
        ...
        #MTpos=MTpos-np.eye(MTpos.shape[0])
        MTpos_1side=MTpos_perm.copy()#MT.copy()
#        MTpos_1side[MTpos_1side<t_threshold]=0
...
#        print Tpos_max_perm[pcnt]
    ...
    if len(pval_sig)>0:
        for pvs,pvalsig in enumerate(pval_sig):
            ...
            out_fname=out_path+'NBSnetwork_pos_cluster'+str(pvs)+'_'+parc_names[wparc]+'_'+event_names[thisev]+'_'+event_names[refev]+'_'+freq_names[thisfreq]+'_'+timesmin[thist]+'_'+timesmax[thist]+'_'+str(p_threshold)[2:]+'.mat'
    ...
    #MTpos=MTpos-np.eye(MTpos.shape[0])
    MTneg_1side=MTneg.copy()#MT.copy()
...
#        MTpos_perm
        ...
        #MTneg=MTneg-np.eye(MTneg.shape[0])
        MTneg_1side=MTneg_perm.copy()#MT.copy()
#        MTneg_1side[MTneg_1side>-t_threshold]=0
...
#        MTneg_perm=MTneg_perm-np.eye(MTneg_perm.shape[0])
        ...
        Tneg_max_perm[pcnt]=np.max(Tneg_sum_perm)
