...
for ii, meg in enumerate(ll):
    ...
    for bcnt,b in enumerate(bands):
        ...
        raw.filter(l_freq=freqmin, h_freq=freqmax,  l_trans_bandwidth=1,h_trans_bandwidth=1, picks=picks, method='fft',filter_length='auto',phase='zero-double')
...
#            ediv=np.sqrt(edv)
    ...
    #        this_stc.resample(200)
            data_out = data_path + meg + 'firstMorphed2_ico_SemDec_pnt1_48ica_'+event_names[evcnt]+'_Source_signedEvoked_m300_600_'+b
