...
thresh_connmat_modules_file=module_path+'grand_modconnmat_maxctf_thresh_modules3conds.mat'
...
file_modules=module_path+'finalmodules_maxctf_3conds.mat'
...
n_permutations=1000
tail=0
for thist in range(len(timesmin)):
        
    thisX=thresh_connmat_modules[:,:,:,thisfreq,thist,thisev]-thresh_connmat_modules[:,:,:,thisfreq,thist,refev]
...
#            p[uvcnt1,uvcnt2] = stats.t.sf(np.abs(MT[uvcnt1,uvcnt2]), n_subjects-1)*2#stats.t.sf(MT[uvcnt1,uvcnt2], n_subjects-1)#
            MT[uvcnt1,uvcnt2], p[uvcnt1,uvcnt2]= scipy.stats.wilcoxon(thisX[:,uvcnt1,uvcnt2])#, method='relative')
#            p[uvcnt1,uvcnt2] = stats.t.sf(np.abs(MT[uvcnt1,uvcnt2]), n_subjects-1)*2
