...
#    conind=0
    for event_no in which_conds:
        fname_in = data_path + meg + 'firstMorphed3_ico_SemDec_pnt1_48ica_'+event_names[event_no]+'_Source_signedEvoked_m300_600_'+b#'firstMorphed_ico_SemDec_pnt1_30ica_'+event_names[event_no]+'_Source_Evoked_mnrsmpl_50_550_100ms_0ov'#'_Source_Evoked_m300_600'#'_Source_Evoked_mnrsmpl_50_550_100ms_0ov'
...
this_pathto=out_path+b+'3_wbw_ROItcs_normal_meanflip_ROI_ATAGIFGMTGVISHRHN_evVisHrHn.mat'#'DKA68_orig_modified_coh.mat'#lh.fsaverage_finalpostparc_smooth_split_merge.annot            
