...
#        print Tpos_max_perm[pcnt]
    ...
    if len(pval_sig)>0:
        for pvs,pvalsig in enumerate(pval_sig):
            ...
            out_fname=out_path+'NBSnetwork_pos_cluster'+str(pvs)+'_'+parc_names[wparc]+'_'+event_names[thisev]+'_'+event_names[refev]+'_'+freq_names[thisfreq]+'_'+timesmin[thist]+'_'+timesmax[thist]+'_'+str(p_threshold)[2:]+'_'+str(thisp)[2:6]+'.mat'
