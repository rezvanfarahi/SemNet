...
#   fname_cov = data_path + meg + 'SemDec_blocks_tsss_filt_pnt1_48_ica_newreg_noise-cov.fif'
...
#   mne.add_source_space_distances(sub_src)
   ...
   write_inverse_operator(data_path + meg + 'InvOp_ico5oldreg_fft_pnt1_30_clean_ica_EMEG-inv.fif', inverse_operator_meeg)
