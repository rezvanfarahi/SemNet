...
labellist=['middle_superiorfrontal','inferior2_precentral', 'middle_temporal', 'anterior_inferiorfrontal','anterior_fusiform','superior2_precentral', 'inferior2_postcentral',  'superior2_postcentral', 'anterior_superiorfrontal',  'posterior_fusiform', 'superior_temporal', 'posterior_inferiorfrontal','posterior_superiorfrontal', 'ATL_latmed']
...
fname='/imaging/rf02/TypLexMEG/fsaverage/label/lh.rez_aparc_24sep15.annot'
mnewa(fname, annotl, CTAB_L, NAMES_L)

fname='/imaging/rf02/TypLexMEG/fsaverage/label/rh.rez_aparc_24sep15.annot'
