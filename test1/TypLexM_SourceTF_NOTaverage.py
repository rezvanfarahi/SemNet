...
# subtract the evoked response in order to exclude evoked activity
	...
	for ii, (this_epochs, title) in enumerate(zip([epochs_concrete, epochs_induced_concrete], ['evoked + induced', 'induced only'])):
	  # Source Induced Power and phase locking in label
            power_concrete2 = source_induced_power(this_epochs, inv_op, frequencies, label=labeldat, baseline=(-0.2,0.), baseline_mode='percent', n_cycles=n_cycles, pca=True, n_jobs=1, method='MNE')
