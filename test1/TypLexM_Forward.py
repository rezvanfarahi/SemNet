...
do
  ...
  mne_check_eeg_locations --file ${datapath}/${subj_pre[m]}/${subj_dir[m]}/typlex_pw_raw_ssst.fif  \
                           --fix
  ...
  mne_do_forward_solution \
                        ...
                        --meas ${datapath}/${subj_pre[m]}/${subj_dir[m]}/typlex_pw_raw_ssst.fif  \
                        --fwd ${datapath}/${subj_pre[m]}/${subj_dir[m]}/forward_5-3L-EMEG-fwd.fif
  ...
  mne_do_forward_solution \
                        ...
                        --src ${MRIpath}/${subjects[m]}/bem/${subjects[m]}-5-src.fif \
                        --meas ${datapath}/${subj_pre[m]}/${subj_dir[m]}/typlex_pw_raw_ssst.fif \
                        --fwd ${datapath}/${subj_pre[m]}/${subj_dir[m]}/forward_5-1L-MEG-fwd.fif
