...
import numpy as np
import mne
from mne import (io, whiten_evoked)
...
for ii, meg in enumerate(ll):
	...
	morphmat1=mne.compute_morph_matrix(subject_from, subject_to, condition1.vertno, vertices_to, subjects_dir=data_path)
	morphmat2=mne.compute_morph_matrix(subject_from, subject_to, condition2.vertno, vertices_to, subjects_dir=data_path)
	...
	data_out = data_path + meg + 'firstMorphed_Whitened_SemLoc_icaclean_Concrete_Source_Evoked_m500_700'
	stc1.save(data_out)
	data_out = data_path + meg + 'firstMorphed_Whitened_SemLoc_icaclean_Abstract_Source_Evoked_m500_700'
	stc2.save(data_out)
