...
in_file1=data_path + 'GrandAverage_SemLoc_Concrete_Power_alpha'
stc1 = mne.read_source_estimate(in_file1)  
in_file2=data_path + 'GrandAverage_SemLoc_Abstract_Power_alpha'
stc2 = mne.read_source_estimate(in_file2)  
out_file=data_path + 'GrandAverage_SemLoc_Subtract_Power_alpha'
stc_subtract=np.subtract(stc1,stc2)
stc_subtract.save(out_file)

"""
	out_file1=data_path + 'GrandAverage_SemLoc_Abstract_Coherence_alphaalpha_150_350_'  
	stcs1 = mne.read_source_estimate(out_file1)
	out_file2=data_path + 'GrandAverage_SemLoc_Abstract_Coherence_alphaalpha_150_350_'  
	stcs2 = mne.read_source_estimate(out_file2)
	stc_subtract=np.mean([stcs1,stcs2])
out_file=data_path + 'GrandAverage_SemLoc_Abstract_Coherence_alphaalpha_150_350_'  
