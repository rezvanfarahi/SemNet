# -*- coding: utf-8 -*-
"""
Created on Sun Sep  6 01:34:16 2015
...
psi, freqs, times, n_epochs, _ =mne.connectivity.spectral_connectivity(
    comb_ts, method='coh',mode='multitaper', mt_adaptive=True, indices=indices, sfreq=sfreq,
    fmin=fmin, fmax=fmax, faverage=True, tmin=tmin_con)
