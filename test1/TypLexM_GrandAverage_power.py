...
out_file=out_path + 'GrandAverage_SemLoc_icaclean_Abstract_SourcePower_ratio_m500_700_theta'
...
"""
out_file1=out_path + 'GrandAverage_SemLoc_icaclean_Concrete_SourcePower_ratio_m500_700_gamma'  
stcs1 = mne.read_source_estimate(out_file1)
out_file2=out_path + 'GrandAverage_SemLoc_icaclean_Abstract_SourcePower_ratio_m500_700_gamma' 
stcs2 = mne.read_source_estimate(out_file2)
stc_subtract=np.subtract(stcs1,stcs2)
out_file=out_path + 'GrandAverage_SemLoc_icaclean_Subtract_SourcePower_ratio_m500_700_gamma' 
