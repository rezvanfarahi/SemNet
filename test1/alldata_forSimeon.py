...
for ii, meg in enumerate(ll):
    ...
    event_id = 1  # concrete
    if subject_inds[ii] in np.array([2,3]):
    ...
    data_con=epochs1.get_data()
    print data_con.shape
    data_abs=epochs2.get_data()
    print data_abs.shape
    if not os.path.exists('/imaging/rf02/Simeon/'+meg):
        os.makedirs('/imaging/rf02/Simeon/'+meg)
    path_mtx='/imaging/rf02/Simeon/'+meg+'abstract_matx.mat'
    import scipy
    scipy.io.savemat(path_mtx,{'data_abs':data_abs})
    path_mtx='/imaging/rf02/Simeon/'+meg+'concrete_matx.mat'
    scipy.io.savemat(path_mtx,{'data_con':data_con})
