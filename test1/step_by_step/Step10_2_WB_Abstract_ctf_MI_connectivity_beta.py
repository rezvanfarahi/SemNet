...
labellist=[labelss[ii] for ii in label_index]#labelss[label_index[1]]#[labelss[ii] for ii in label_index]
print labellist
...
#  n_cycles[np.logical_and((frequencies>10), (frequencies<=20))] = 3
    ...
    fname_raw = data_path + meg + 'semloc_ssstf_fft_ica_beta_raw.fif'
...
#            print ccc		
#            data_in = data_path + meg + 'Morphed_SemLoc_epochs' + str(ccc) + '_ica_Abstract_Source_Evoked_m500_700'
...
#            stc_orig.resample(100)
        ...
        data_out = data_path + meg +  'Morphed_ico_SemLoc_ica_equalized_Abstract_new_ctf_MI_Beta_150_450_200ms_' + thislabelname                                        
        print data_out
