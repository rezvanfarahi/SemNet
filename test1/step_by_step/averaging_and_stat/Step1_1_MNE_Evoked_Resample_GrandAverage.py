...
for ii, meg in enumerate(ll):
    print ii
    fname = data_path + meg + 'firstMorphed_ico_SemLoc_ica_Concrete_Source_Evoked_m500_700'  
    ...
    out_file0=data_path + meg + 'firstMorphed_ico_SemLoc_ica_Concrete_Source_Evoked_mnrsmpl_50_550_100ms_0ov'
    matx_stcc.save(out_file0)
    
    fname = data_path + meg + 'firstMorphed_ico_SemLoc_ica_Abstract_Source_Evoked_m500_700'  
    ...
    out_file0=data_path + meg + 'firstMorphed_ico_SemLoc_ica_Abstract_Source_Evoked_mnrsmpl_50_550_100ms_0ov'
    matx_stca.save(out_file0)
    
    matx_stcs=np.subtract(matx_stcc,matx_stca)
    out_file0=data_path + meg + 'firstMorphed_ico_SemLoc_ica_Subtract_Source_Evoked_mnrsmpl_50_550_100ms_0ov'
...
out_file=out_path + 'GrandAverage_firstMorphed_ico_SemLoc_ica_Concrete_Source_Evoked_mnrsmpl_50_550_100ms_0ov'
stc_grandc.save(out_file)

stc_granda=np.mean(stc_alla)
#datag=np.log(stc_grand.data)
#datag_stc = mne.SourceEstimate(datag, vertices=stc_grand.vertno, tmin=stc_grand.tmin, tstep=stc_grand.tstep, subject='fsaverageect')
out_file=out_path + 'GrandAverage_firstMorphed_ico_SemLoc_ica_Abstract_Source_Evoked_mnrsmpl_50_550_100ms_0ov'
stc_granda.save(out_file)


stc_subtract=np.subtract(stc_grandc,stc_granda)
out_file=out_path + 'GrandAverage_firstMorphed_ico_SemLoc_ica_Subtract_Source_Evoked_mnrsmpl_50_550_100ms_0ov' 
