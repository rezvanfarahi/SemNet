...
for ii, meg in enumerate(ll):
	print ii
	fname_c = data_path + meg +  'firstMorphed_ico_SemLoc_ica_Concrete_Source_Evoked_mnrsmpl_50_550_100ms_0ov'
	stc_c = mne.read_source_estimate(fname_c)

	fname_a = data_path + meg +  'firstMorphed_ico_SemLoc_ica_Abstract_Source_Evoked_mnrsmpl_50_550_100ms_0ov'
...
out_file=out_path + 'UVttest_firstMorphed_ico_SemLoc_ica_Sub_Source_Evoked_mnrsmpl_50_550_100ms_0ov'
