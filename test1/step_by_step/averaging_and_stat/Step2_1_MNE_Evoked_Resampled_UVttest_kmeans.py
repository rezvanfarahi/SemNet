...
###############################################################################
out_path = '/imaging/rf02/TypLexMEG/icaanalysis_results/stc/UVttest/evoked/' # root directory for your MEG data
...
for ii, meg in enumerate(ll):
	print ii
	fname_c = data_path + meg +  'firstMorphed_SemLoc_icaclean_Concrete_Source_Evoked_m500_700'#'firstMorphed_SemLoc_icaclean_Concrete_Source_Evoked_meanresampled_50_550_100ms_0overlap'
	stc_c = mne.read_source_estimate(fname_c)
 	stc_c.resample(200)
 	stc_c.crop(0,0.55)
     

	fname_a = data_path + meg +  'firstMorphed_SemLoc_icaclean_Abstract_Source_Evoked_m500_700'#'firstMorphed_SemLoc_icaclean_Abstract_Source_Evoked_meanresampled_50_550_100ms_0overlap'
...
path_idx=data_path+'idx.mat'    
lta=scipy.io.loadmat(path_idx,mat_dtype=True); idx=lta['idx']
idxx=idx==1
idxx=idxx[:,0]
Matx1=Matx_c-Matx_a
Matx=Matx1[idxx,:,:]
...
out_file=out_path + 'UVttest_kmeans1_firstMorphed_SemLoc_icaclean_Subtract_Source_Evoked_meanresampled_50_550_100ms_0overlap'
...
"""
out_file1=out_path + 'GrandAverage_SemLoc_icaclean_Concrete_Source_Evoked_unequalized_meanresampled_50_550_100ms'  
stcs1 = mne.read_source_estimate(out_file1)
out_file2=out_path + 'GrandAverage_SemLoc_icaclean_Abstract_Source_Evoked_unequalized_meanresampled_50_550_100ms' 
stcs2 = mne.read_source_estimate(out_file2)
stc_subtract=np.subtract(stcs1,stcs2)
out_file=out_path + 'GrandAverage_SemLoc_icaclean_Subtract_Source_Evoked_unequalized_meanresampled_50_550_100ms' 
