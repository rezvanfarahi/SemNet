...
out_path = '/imaging/rf02/TypLexMEG/icaanalysis_results/stc/UVttest/connectivity/WB_hubs/newp/'    # where event files are
...
labellist_sv=['ATL-lh','SMG-lh','pIFG-lh','MTL-lh']
...
for label_name, label_name_sv in zip(labellist, labellist_sv):
    ...
    for con_method in conn_methods:
        for band in bands:
            ...
            data_out = out_path +  'UVttest_Morphed_ico_SL_ica_equal_sub_MI_bestV_ctf_'+band+'_150_450_200ms_lh' + label_name_sv[0:-3] 
