...
out_path = '/imaging/rf02/TypLexMEG/icaanalysis_results/stc/GrandAverage/connectivity/WB_hubs/temporal/newag/'    # where event files are
...
#    	X_gamma=np.zeros((20484,17))
    ...
    ### Concrete
     ...
     #X = np.transpose(X, [2, 1, 0])	
    	...
    	data_out = out_path +  'Grandaverage_firstMorphed_SemLoc_icaclean_equalized_Subtract_MutualInfo_150_450_200ms_' + label_name[0:-3]
    	X_stc.save(data_out)
