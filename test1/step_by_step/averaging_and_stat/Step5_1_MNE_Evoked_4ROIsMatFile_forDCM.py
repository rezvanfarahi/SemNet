...
lfname=data_path+'fsaverage/label/lh.WFA_DCM-lh.label'
labelwfa=mne.read_label(lfname,subject='fsaverage')
labellist.append(labelwfa)
print labellist
...
#    abs_mat=np.concatenate((abs_label1,abs_label2),0)       
    ...
    out_file=out_path + meg[:10] + '_TypLex_Evoked_5ROIs_forDCM.mat'
