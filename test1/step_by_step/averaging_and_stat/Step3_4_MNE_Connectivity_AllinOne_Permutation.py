...
out_path = '/imaging/rf02/TypLexMEG/icaanalysis_results/stc/permutation/connectivity/WB_hubs/st/newag2/'    # where event files are
...
p_list=[0.05,0.045,0.04,0.03,0.025,0.02,0.01,0.008,0.005,0.002,0.001, 0.0008,0.0005]#[0.05,0.025,0.01,0.008,0.005,0.002,0.001]#[0.005,0.01,0.025, 0.05]#,0.045,0.04,0.03,0.025,0.02,0.01,0.008,0.005,0.002,0.001,0.0005,0.0001]
...
#            		fname_cncrt = data_path + meg + 'Morphed_ico_SemLoc_ica_equalized_Concrete_new_ctf_MI_150_450_200ms_' + label_name[0:-3] 
            		...
            		fname_cncrt = data_path + meg + 'Morphed_ico_SemLoc_ica_equalized_Concrete_Mlttap_new_ctf_PPC_'+band+'_150_450_200ms_' + label_name[0:-3] 
...
#            		fname_abs = data_path + meg + 'Morphed_ico_SemLoc_ica_equalized_Abstract_new_ctf_MI_150_450_200ms_' + label_name[0:-3]   
            		...
            		fname_abs = data_path + meg + 'Morphed_ico_SemLoc_ica_equalized_Abstract_Mlttap_new_ctf_PPC_'+band+'_150_450_200ms_' + label_name[0:-3] 
...
#            	Xcf=np.hstack((np.squeeze(Xc[:,:,0,:]),np.squeeze(Xc[:,:,1,:]),np.squeeze(Xc[:,:,2,:]))) #mi, wpli, coh
#            	Xaf=np.hstack((np.squeeze(Xa[:,:,0,:]),np.squeeze(Xa[:,:,1,:]),np.squeeze(Xa[:,:,2,:])))
#                   
...
#                    p_thresh=0.1#0.05; print p_thresh
#                    
...
#                    out_file1=out_path + 'ClusP2_Morphed_ico_SL_ica_equal_Sub_new_ctf_ST_'+band+'_150_450_200ms_ms' + str(max_step) +'_'+ str(p_threshold)[2:5] + '_sx_' + str(p_thresh)[2:5]+ '_' + label_name_sv[0:-3]
...
#                    out_file2=out_path + 'ClusP2_sw_Morphed_ico_SL_ica_equal_Sub_new_ctf_ST_'+band+'_150_450_200ms_ms' + str(max_step) +'_sx_'+ str(p_threshold)[2:5] + '_' + str(p_thresh)[2:5]+ '_' + label_name_sv[0:-3]
