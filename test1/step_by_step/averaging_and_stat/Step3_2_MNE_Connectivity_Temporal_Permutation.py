...
out_path = '/imaging/rf02/TypLexMEG/icaanalysis_results/stc/permutation/connectivity/WB_hubs/temporal/newag/'    # where event files are
    ...
    for label_name,label_name_sv in zip(labellist,labellist2):
            ...
            ### Concrete
            	...
            	if cluster_p_valuest.min() < 0.05:#clus_p_values.min()<0.003125:
                    ...
                    stc_all_cluster_vist = summarize_clusters_stc(clut, tstep=tstep, p_thresh=p_thresh1+0.000001, vertno=fsave_vertices, subject='fsaverage')
                    out_file1=out_path + 'ClusP_Morphed_ico_SL_ica_equal_Sub_new_ctf_MI_'+band+'_150_450_200ms_ms' + str(max_step) +'_'+ str(p_threshold)[2:5] + '_sx_' + str(p_thresh)[2:5]+ '_' + label_name_sv[0:-3]
                    ...
                    out_file2=out_path + 'ClusP_sw_Morphed_ico_SL_ica_equal_Sub_new_ctf_MI_'+band+'_150_450_200ms_ms' + str(max_step) +'_sx_'+ str(p_threshold)[2:5] + '_' + str(p_thresh)[2:5]+ '_' + label_name_sv[0:-3]
