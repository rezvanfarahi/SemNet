...
out_path = '/imaging/rf02/TypLexMEG/icaanalysis_results/stc/permutation/connectivity/WB_hubs/st/newag_coh_allfreqs/'    # where event files are
...
p_list=[0.02,0.01,0.008,0.005]#[0.05,0.025,0.01,0.008,0.005,0.002,0.001]#[0.005,0.01,0.025, 0.05]#,0.045,0.04,0.03,0.025,0.02,0.01,0.008,0.005,0.002,0.001,0.0005,0.0001]
...
#        		scipy.io.savemat(path_mtx,{'Xa':Xa})            
            	...
            	print('Clustering theta'); max_step=0;
            	T_obst, clusterst, cluster_p_valuest, H0t = clut = spatio_temporal_cluster_1samp_test(X, connectivity=connectivity,  n_permutations=n_permutations, n_jobs=8, threshold=t_threshold, tail=0,t_power=1, spatial_exclude=spatial_exclude,step_down_p=0.05, max_step=0)
            	...
            	if cluster_p_valuest.min()<=0.1:
                    ...
                    out_file1=out_path + 'ClusP_Morphed_ico_SL_ica_equal_Sub_new_ctf_ST_allbands_150_450_200ms_ms' + str(max_step) +'_'+ str(p_threshold)[2:5] + '_sx_' + str(p_thresh)[2:5]+ '_' + label_name_sv[0:-3]
                    ...
                    out_file2=out_path + 'ClusP_sw_Morphed_ico_SL_ica_equal_Sub_new_ctf_ST_allbands_150_450_200ms_ms' + str(max_step) +'_sx_'+ str(p_threshold)[2:5] + '_' + str(p_thresh)[2:5]+ '_' + label_name_sv[0:-3]
