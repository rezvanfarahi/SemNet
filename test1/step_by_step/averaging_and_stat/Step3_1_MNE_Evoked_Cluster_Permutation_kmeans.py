...
for p_threshold in ll:
    ...
    out_file1=out_path + 'ClusterPermutation_kmeans1_abs_firstmorphed_clusterp'+str(p_threshold)[2:]+'_p'+str(p_thresh)[2:]+'_17subj_SemLoc_icaclean_ConcreteAbstract_50_550_100ms_tail'+str(tail)+'_maxstep'+str(max_step)
    ...
    out_file2=out_path + 'ClusterPermutation_kmeans1_abs_stepwise_firstmorphed_clusterp'+str(p_threshold)[2:]+'_p'+str(p_thresh)[2:]+'_17subj_SemLoc_icaclean_ConcreteAbstract_50_550_100ms_tail'+str(tail)+'_maxstep'+str(max_step)
