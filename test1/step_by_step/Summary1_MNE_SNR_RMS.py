...
inv_fname = 'InverseOperator_oldreg_fft_1_48_clean_ica_EMEG-inv.fif'#'InverseOperator_fft_1_48_clean_ica_EMEG-inv.fif'
...
evoked_ga=mne.grand_average(evoked,interpolate_bads=True)
epdata=evoked_ga.data 
em=epdata#np.abs(epdata)
