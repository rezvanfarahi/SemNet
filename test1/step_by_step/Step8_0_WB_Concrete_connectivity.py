...
#labellist = [ 'lh.posterior_fusiform','rh.posterior_fusiform', 'lh.lateraloccipital','rh.lateraloccipital','lh.precentral','rh.precentral', 'lh.ATLsmall','rh.ATLsmall']#labellist = [ 'leftATL-lh','rightATL-rh']#, 'medialtempright-rh','medialtempleft-lh']'lh.postcentral','rh.postcentral',
...
# Note: We use a hack to save the frequency axis as time
        ...
        data_out = data_path + meg +  'firstMorphed_SemLoc_icaclean_equalized_Concrete_Multitaper_PCALabel_Coherence_Theta_150_450_200ms_' + label_name[0:-3]
        print 'theta'
        ...
        data_out = data_path + meg +  'firstMorphed_SemLoc_icaclean_equalized_Concrete_Multitaper_PCALabel_Coherence_Alpha_150_450_200ms_' + label_name[0:-3]
        print 'alpha'
        coh_stc.save(data_out)
        
        coh_stc = mne.SourceEstimate(coh[:,2,:], vertices=stc_coh.vertices, tmin= tmin1, tstep= tstep1, subject='fsaverage')
        data_out = data_path + meg +  'firstMorphed_SemLoc_icaclean_equalized_Concrete_Multitaper_PCALabel_Coherence_Beta_150_450_200ms_' + label_name[0:-3]
        print 'beta'
        coh_stc.save(data_out)
        
        coh_stc = mne.SourceEstimate(coh[:,3,:], vertices=stc_coh.vertices, tmin= tmin1, tstep= tstep1, subject='fsaverage')
        data_out = data_path + meg +  'firstMorphed_SemLoc_icaclean_equalized_Concrete_Multitaper_PCALabel_Coherence_Gamma_150_450_200ms_' + label_name[0:-3]
        print 'gamma'
        coh_stc.save(data_out)
...
# Note: We use a hack to save the frequency axis as time
        ...
        data_out = data_path + meg +  'firstMorphed_SemLoc_icaclean_equalized_Concrete_Multitaper_PCALabel_PPC_Theta_150_450_200ms_' + label_name[0:-3]
        print 'theta'
        coh_stc.save(data_out)
        
        coh_stc = mne.SourceEstimate(dw_pli[:,1,:], vertices=stc_coh.vertices, tmin= tmin1, tstep= tstep1, subject='fsaverage')
        data_out = data_path + meg +  'firstMorphed_SemLoc_icaclean_equalized_Concrete_Multitaper_PCALabel_PPC_Alpha_150_450_200ms_' + label_name[0:-3]
        print 'alpha'
        coh_stc.save(data_out)
        
        coh_stc = mne.SourceEstimate(dw_pli[:,2,:], vertices=stc_coh.vertices, tmin= tmin1, tstep= tstep1, subject='fsaverage')
        data_out = data_path + meg +  'firstMorphed_SemLoc_icaclean_equalized_Concrete_Multitaper_PCALabel_PPC_Beta_150_450_200ms_' + label_name[0:-3]
        print 'beta'
        coh_stc.save(data_out)
        
        coh_stc = mne.SourceEstimate(dw_pli[:,3,:], vertices=stc_coh.vertices, tmin= tmin1, tstep= tstep1, subject='fsaverage')
        data_out = data_path + meg +  'firstMorphed_SemLoc_icaclean_equalized_Concrete_Multitaper_PCALabel_PPC_Gamma_150_450_200ms_' + label_name[0:-3]
        print 'gamma'
        coh_stc.save(data_out)
