...
colors=nc(len(labels)/2,bytes_=True, cmap='gist_ncar')
...
make_parcellation_mine(src_avg,labels,colors,subject_avg,fname)
...
### end of the while loop
    ...
    fname='finalpostparc_smooth_stddiff_LRmirror_wmerge_'+str(whilec)+'_'+str(lennew)
