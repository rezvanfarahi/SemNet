# -*- coding: utf-8 -*-
"""
Created on Thu Oct  8 17:59:42 2015
...
# Writing events
	...
	out_namet=data_path + meg + 'semloc_ssstf_fft_ica_theta_raw.fif'
	out_namea=data_path + meg + 'semloc_ssstf_fft_ica_alpha_raw.fif'
	out_nameb=data_path + meg + 'semloc_ssstf_fft_ica_beta_raw.fif'
	out_nameg=data_path + meg + 'semloc_ssstf_fft_ica_gamma_raw.fif'
