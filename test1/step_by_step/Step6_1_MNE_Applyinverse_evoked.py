...
for ii, meg in enumerate(ll):
    ...
    event_id = 1  # concrete
    if subject_inds[0] in np.array([2,3]):
...
# 
    data_out = data_path + meg + 'firstMorphed_ico_signed_SemLoc_ica_Concrete_Source_Evoked_m500_700'
    stc1.save(data_out)
    data_out = data_path + meg + 'firstMorphed_ico_signed_SemLoc_ica_Abstract_Source_Evoked_m500_700'
    stc2.save(data_out)
