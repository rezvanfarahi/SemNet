...
for ii, meg in enumerate(ll):
    ...
    for ccc, con1 in enumerate(condition1):
        ...
        data_out1 = data_path + meg + 'Morphed_ico_typlex_epochs' + str(ccc) + '_icaclean_word_Source_Evoked_m500_700'
    ...
    for ccc, con2 in enumerate(condition2):
        ...
        data_out2 = data_path + meg + 'Morphed_ico_typlex_epochs' + str(ccc) + '_icaclean_nonword_Source_Evoked_m500_700'
