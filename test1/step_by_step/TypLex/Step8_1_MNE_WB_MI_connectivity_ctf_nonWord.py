...
from mne.minimum_norm import psf_ctf_new
...
# Load data
    ...
    stc_ctf_mne=psf_ctf_new.cross_talk_function(inverse_operator, forward, labels,method=method, lambda2=lambda2, signed=False, mode=mode, n_svd_comp=1, verbose=None)
...
# n_cycles[np.logical_and((frequencies>10), (frequencies<=20))] = 3
        ...
        for ccc in range(len(stcs)):
            ...
            #theta
            sdat_theta=mne.filter.band_pass_filter(sdat.copy(),Fs=1./stc_orig.tstep,Fp1=4., Fp2=7., l_trans_bandwidth=0.1, picks=picks, method='fft')
            ...
            #alpha
            sdat_alpha=mne.filter.band_pass_filter(sdat.copy(),Fs=1./stc_orig.tstep,Fp1=8., Fp2=12., l_trans_bandwidth=0.1, picks=picks, method='fft')
            ...
            #beta
            sdat_beta=mne.filter.band_pass_filter(sdat.copy(),Fs=1./stc_orig.tstep,Fp1=13., Fp2=30., l_trans_bandwidth=0.1, picks=picks, method='fft')
            ...
            #gamma
            sdat_gamma=mne.filter.band_pass_filter(sdat.copy(),Fs=1./stc_orig.tstep,Fp1=31., Fp2=45., l_trans_bandwidth=0.1, picks=picks, method='fft')
...
#            stc_orig.resample(100)
        ...
        data_out = data_path + meg +  'Morphed_SemLoc_ica_equalized_nonword_bestV_ctf_MI_Theta_150_450_200ms_' + label1.name[:-3]                                        
        print data_out
        ...
        data_out = data_path + meg +  'Morphed_SemLoc_ica_equalized_nonword_bestV_ctf_MI_Alpha_150_450_200ms_' + label1.name[:-3]                                        
        print data_out
        ...
        data_out = data_path + meg +  'Morphed_SemLoc_ica_equalized_nonword_bestV_ctf_MI_Beta_150_450_200ms_' + label1.name[:-3]                                        
        print data_out
        ...
        data_out = data_path + meg +  'Morphed_SemLoc_ica_equalized_nonword_bestV_ctf_MI_Gamma_150_450_200ms_' + label1.name[:-3]                                        
        print data_out
