...
for ii, meg in enumerate(ll):
    ...
    raw_fname = data_path + meg + 'typlex_pw_ssstf_fft_ica_theta_raw.fif' #clean_ssp_
    ...
    for ccc, con1 in enumerate(condition1):
        ...
        data_out1 = data_path + meg + 'Morphed_ico_TypLex_epochs' + str(ccc) + '_icaclean_word_Source_Theta_m500_700'
    ...
    for ccc, con2 in enumerate(condition2):
        ...
        data_out2 = data_path + meg + 'Morphed_ico_TypLex_epochs' + str(ccc) + '_icaclean_nonword_Source_Theta_m500_700'
