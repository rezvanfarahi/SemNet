...
out_path = '/imaging/rf02/TypLexMEG/icaanalysis_results/typlex/stc/GrandAverage/connectivity/WB_hubs/temporal/'    # where event files are
...
for label_name in labellist:
    ...
    for band in bands:
        ...
        #    	X_gamma=np.zeros((20484,17))
            ...
            ### Concrete
            		fname_cncrt = data_path + meg + 'Morphed_SemLoc_ica_equalized_word_bestV_ctf_MI_'+band+'_150_450_200ms_' + label_name[0:-3]                                                        
              
            		stc_cncrt = mne.read_source_estimate(fname_cncrt);# stc_cncrt.data[stc_cncrt.data<0]=0                      
            		fname_abs = data_path + meg + 'Morphed_SemLoc_ica_equalized_nonword_bestV_ctf_MI_'+band+'_150_450_200ms_' + label_name[0:-3]  
            		...
            		X[:,:,ii]=stc_cncrt.data#stc_data_subtract#stc_subtract.data
             ...
             #X = np.transpose(X, [2, 1, 0])	
            	...
            	data_out = out_path +  'Grandaverage_Morphed_typlex_ica_equal_word_bestV_ctf_MI_'+band+'_150_450_200ms_lh' + label_name[0:-3]
            	X_stc.save(data_out)
