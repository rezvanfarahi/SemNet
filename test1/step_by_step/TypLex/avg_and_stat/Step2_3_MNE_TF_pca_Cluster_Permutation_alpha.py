...
out_path = '/imaging/rf02/TypLexMEG/icaanalysis_results/typlex/stc/permutation/power/pca4/' #
...
p_list=[0.075,0.05,0.045,0.04,0.03,0.025,0.01,0.008,0.005,0.002,0.001,0.0005,0.0001]
print "subject_inds:"
print subject_inds
print "No rejection"
...
for p_threshold in ll:
    for which_pc in range(4):
        ...
        ### word
        	...
        	fname_cncrt = data_path + meg + 'mineMorphed_ico_TypLex_ica_word_Power_normori_ratio_equalized_m500_700_200hz_' +b#'mineMorphed_ico_TypLex_icaclean_word_Power_ratio_equalized_m500_700_' + b
    ...
    #    X=np.squeeze(np.subtract(Xc_score[:,:,:,which_pc],Xa_score[:,:,:,which_pc]));
        path_mtx=data_path+'icaanalysis_results/tf_pca/WB_PCA_acrossverts_TL_allbands_Xbscore.mat'
    ...
    #    print cluster_p_values.min()
        ...
        if cluster_p_values.min()<=0.05:#clus_p_values.min()<=0.01 and cluster_p_values.min()<=0.1:
            ...
            out_file1=out_path + 'Per_clusp'+str(p_threshold)[2:]+'_p'+str(cluster_p_values.min())[2:]+'_TL_ica_Subtract_Power_ratio_ico_normori_eq_50_550_100ms_sx_ms' + str(max_step) +'_pc'+str(which_pc+1)
            ...
            out_file2=out_path + 'Per_sw_clusp'+str(p_threshold)[2:]+'_p'+str(p_thresh)[2:]+'_TL_ica_Subtract_Power_ratio_normori_eq_50_550_100ms_sx_ms' + str(max_step) +'_pc'+str(which_pc+1)
