...
out_path = '/imaging/rf02/TypLexMEG/icaanalysis_results/typlex/stc/permutation/connectivity/WB_hubs/temporal/newag/'    # where event files are
...
p_list=[0.2,0.1, 0.075,0.05,0.045,0.04,0.03,0.025,0.02,0.01,0.008,0.005,0.002,0.001, 0.0008,0.0005]#[0.05,0.025,0.01,0.008,0.005,0.002,0.001]#[0.005,0.01,0.025, 0.05]#,0.045,0.04,0.03,0.025,0.02,0.01,0.008,0.005,0.002,0.001,0.0005,0.0001]
print "subject_inds:"
print subject_inds
print "No rejection"
...
for p_threshold in ll:
    for label_name,label_name_sv in zip(labellist,labellist2):
            ...
            ### Concrete
            		fname_cncrt = data_path + meg + 'Morphed_ico_typlex_ica_equalized_word_new_ctf_MI_'+band+'_150_450_200ms_' + label_name 
            	...
            	if cluster_p_valuest.min() < 0.05:#clus_p_values.min()<0.003125:
                    ...
                    out_file1=out_path + 'ClusP_Morphed_ico_TL_ica_equal_Sub_new_ctf_MI_'+band+'_150_450_200ms_ms' + str(max_step) +'_'+ str(p_threshold)[2:5] + '_sx_' + str(p_thresh)[2:5]+ '_' + label_name_sv[0:-3]
                    ...
                    out_file2=out_path + 'ClusP_sw_Morphed_ico_TL_ica_equal_Sub_new_ctf_MI_'+band+'_150_450_200ms_ms' + str(max_step) +'_sx_'+ str(p_threshold)[2:5] + '_' + str(p_thresh)[2:5]+ '_' + label_name_sv[0:-3]
