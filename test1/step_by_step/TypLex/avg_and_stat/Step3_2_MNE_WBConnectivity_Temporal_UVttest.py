    ...
    for con_method in conn_methods:
        for band in bands:
            ...
            for meg in list_all:
                ...
                ### word
                fname_cncrt = data_path + meg + 'Morphed_ico_typlex_ica_equalized_word_bestV_ctf_MI_'+band+'_150_450_200ms_' + label_name[0:-3] 
                stc_cncrt = mne.read_source_estimate(fname_cncrt); #stc_cncrt.data[stc_cncrt.data<0]=0 
                fname_abs = data_path + meg + 'Morphed_ico_typlex_ica_equalized_nonword_bestV_ctf_MI_'+band+'_150_450_200ms_' + label_name[0:-3]  
            ...
            data_out = out_path +  'UVttest_Morphed_ico_TL_ica_equal_sub_MI_bestV_ctf_'+band+'_150_450_200ms_lh' + label_name_sv[0:-3] 
