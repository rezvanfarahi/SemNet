...
###############################################################################
out_path = '/imaging/rf02/TypLexMEG/icaanalysis_results/typlex/stc/UVttest/power/final/' # root directory for your MEG data
...
for ii, meg in enumerate(ll):
	print ii
	fname_c = data_path + meg +  'mineMorphed_ico_TypLex_ica_word_Power2_normori_ratio_equalized_50_550_100ms_0ov_200hz_' +b#'mineMorphed_typlex_icaclean_word_rPLV_ratio_equalized_meanresampled_50_550_100ms_0overlap_' +b
	stc_c = mne.read_source_estimate(fname_c)

	fname_a = data_path + meg +  'mineMorphed_ico_TypLex_ica_nonword_Power2_normori_ratio_equalized_50_550_100ms_0ov_200hz_' +b#'mineMorphed_typlex_icaclean_nonword_rPLV_ratio_equalized_meanresampled_50_550_100ms_0overlap_' +b
	stc_a = mne.read_source_estimate(fname_a)
	
	Matx_c[ii,:,:]=stc_c.copy().data.squeeze()
	Matx_a[ii,:,:]=stc_a.copy().data.squeeze()

Matx=Matx_c-Matx_a#np.log(np.divide(Matx_c,Matx_a))#
...
#out_file=out_path + 'GrandAverage_SemLoc_icaclean_Concrete_Sourceinduced_rPLV_ratio_equalized_gamma_meanresampled_50_550_100ms'
#stc_grand.save(out_file)

out_file=out_path + 'UVttest_mineMorphed_ico_TypLex_ica_sub_Power2_normori_ratio_equalized_mn_rsmpl_200hz_' +b
...
in_file1=out_path + 'GrandAverage_SemLoc_ica_Subtract_SourcerPLV_ratio_equalized_m500_700_gamma'  
