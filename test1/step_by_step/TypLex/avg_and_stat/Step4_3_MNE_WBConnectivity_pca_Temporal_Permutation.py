...
out_path = '/imaging/rf02/TypLexMEG/icaanalysis_results/typlex/stc/permutation/connectivity/WB_hubs/spectral/pca4/'    # where event files are
...
for p_threshold in ll:
    ...
    #            	X=np.squeeze(np.subtract(Xc_score[:,:,:,which_pc],Xa_score[:,:,:,which_pc]));	
                	path_mtx=data_path+'icaanalysis_results/conn_pca/WB_PCA_ppc_acrossverts_TL_allbands_Xbscore_'+label_name_sv[0:-3]+'.mat'
    ...
    #                matx_stc.save(out_file2)
                	...
                	if cluster_p_valuest.min() < 0.05:#clus_p_values.min()<0.003125:
                            ...
                            out_file1=out_path + 'ClusP_Morphed_ico_TL_ica_equal_Sub_new_ctf_ppc_pc'+str(which_pc)+'_150_450_200ms_ms' + str(max_step) +'_'+ str(p_threshold)[2:5] + '_sx_' + str(p_thresh)[2:5]+ '_' + label_name_sv[0:-3]
                            ...
                            out_file2=out_path + 'ClusP_sw_Morphed_ico_TL_ica_equal_Sub_new_ctf_ppc_pc'+str(which_pc)+'_150_450_200ms_ms' + str(max_step) +'_sx_'+ str(p_threshold)[2:5] + '_' + str(p_thresh)[2:5]+ '_' + label_name_sv[0:-3]
                            matx_stc.save(out_file2)
