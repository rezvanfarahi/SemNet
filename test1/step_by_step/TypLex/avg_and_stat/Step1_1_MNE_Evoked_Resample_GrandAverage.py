...
###############################################################################
out_path = '/imaging/rf02/TypLexMEG/icaanalysis_results/typlex/stc/GrandAverage/evoked/' # root directory for your MEG data
...
for ii, meg in enumerate(ll):
    ...
    out_file0=data_path + meg + 'firstMorphed_ico_typlex_ica_word_Source_Evoked_meanresampled_50_550_100ms_0overlap'
    ...
    out_file0=data_path + meg + 'firstMorphed_ico_typlex_ica_nonword_Source_Evoked_meanresampled_50_550_100ms_0overlap'
    matx_stca.save(out_file0)
    
    matx_stcs=np.subtract(matx_stcc,matx_stca)
    out_file0=data_path + meg + 'firstMorphed_ico_typlex_ica_Subtract_Source_Evoked_meanresampled_50_550_100ms_0overlap'
...
out_file=out_path + 'GrandAverage_firstmorphed_ico_typlex_ica_word_Source_Evoked_meanresampled_50_550_100ms_0overlap'
stc_grandc.save(out_file)

stc_granda=np.mean(stc_alla)
#datag=np.log(stc_grand.data)
#datag_stc = mne.SourceEstimate(datag, vertices=stc_grand.vertno, tmin=stc_grand.tmin, tstep=stc_grand.tstep, subject='fsaverageect')
out_file=out_path + 'GrandAverage_firstmorphed_ico_typlex_ica_nonword_Source_Evoked_meanresampled_50_550_100ms_0overlap'
stc_granda.save(out_file)


stc_subtract=np.subtract(stc_grandc,stc_granda)
out_file=out_path + 'GrandAverage_firstmorphed_ico_typlex_ica_Subtract_Source_Evoked_meanresampled_50_550_100ms_0overlap' 
stc_subtract.save(out_file)

"""
import matplotlib.pyplot as plt
in_file1=out_path + 'GrandAverage_SemLoc_ica_oldreg_Subtract_SourcePower_ratio_m500_700_theta'  
stc1=mne.read_source_estimate(in_file1)
in_file2=out_path + 'GrandAverage_SemLoc_ica_oldreg_Subtract_SourcePower_ratio_m500_700_alpha' 
stc2=mne.read_source_estimate(in_file2) 
in_file3=out_path + 'GrandAverage_SemLoc_ica_oldreg_Subtract_SourcePower_ratio_m500_700_beta'  
stc3=mne.read_source_estimate(in_file3)
in_file4=out_path + 'GrandAverage_SemLoc_ica_oldreg_Subtract_SourcePower_ratio_m500_700_gamma'  
