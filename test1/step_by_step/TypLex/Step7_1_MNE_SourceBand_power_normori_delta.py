...
## epoching
    ...
    snr = ediv.mean()
    lambda2 = 1.0 / snr ** 2
    cwt_frequencies = np.arange(1.6, 4, 1)#np.array([6,10,22,38])#
    cwt_n_cycles = 1.#cwt_frequencies / float(3)
    ...
    data_out = data_path + meg + 'mineMorphed_ico_TypLex_ica_word_Power_normori_ratio_equalized_m500_700_200hz_' + b
    cp_stc.save(data_out)
    data_out = data_path + meg + 'mineMorphed_ico_TypLex_ica_word_rPLV_normori_ratio_equalized_m500_700_200hz_' + b
    ...
    data_out = data_path + meg + 'mineMorphed_ico_TypLex_ica_nonword_Power_normori_ratio_equalized_m500_700_200hz_' + b
    ap_stc.save(data_out)
    data_out = data_path + meg + 'mineMorphed_ico_TypLex_ica_nonword_rPLV_normori_ratio_equalized_m500_700_200hz_' + b
