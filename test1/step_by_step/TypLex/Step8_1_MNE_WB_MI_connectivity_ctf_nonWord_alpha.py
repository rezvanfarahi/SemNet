...
#  n_cycles[np.logical_and((frequencies>10), (frequencies<=20))] = 3
    ...
    fname_raw = data_path + meg + 'typlex_pw_ssstf_fft_ica_alpha_raw.fif'
...
# n_cycles[np.logical_and((frequencies>10), (frequencies<=20))] = 3
        ...
        for ccc in range(len(stcs)):
            print ccc		
            data_in = data_path + meg + 'Morphed_ico_TypLex_epochs' + str(ccc) + '_icaclean_nonword_Source_Alpha_m500_700'
...
#            stc_orig.resample(100)
        ...
        data_out = data_path + meg +  'Morphed_ico_typlex_ica_equalized_nonword_new_ctf_MI_Alpha_150_450_200ms_' + thislabelname                                        
        print data_out
