...
# Read epochs
    ...
    for ccc in range(len(stcs)):
        print ccc		
        data_in = data_path + meg + 'Morphed_ico_typlex_epochs' + str(ccc) + '_icaclean_word_Source_Evoked_m500_700'
...
# Note: We use a hack to save the frequency axis as time
        ...
        data_out = data_path + meg +  'Morphed_ico_typlex_ica_equalized_word_Mlttap_new_ctf_Coherence_Theta_150_450_200ms_' + thislabelname
        print 'theta'
        ...
        data_out = data_path + meg +  'Morphed_ico_typlex_ica_equalized_word_Mlttap_new_ctf_Coherence_Alpha_150_450_200ms_' + thislabelname
        print 'alpha'
        coh_stc.save(data_out)
        
        coh_stc = mne.SourceEstimate(coh[:,2,:], vertices=stc_coh.vertices, tmin= tmin1, tstep= tstep1, subject='fsaverage')
        data_out = data_path + meg +  'Morphed_ico_typlex_ica_equalized_word_Mlttap_new_ctf_Coherence_Beta_150_450_200ms_' + thislabelname
        print 'beta'
        coh_stc.save(data_out)
        
        coh_stc = mne.SourceEstimate(coh[:,3,:], vertices=stc_coh.vertices, tmin= tmin1, tstep= tstep1, subject='fsaverage')
        data_out = data_path + meg +  'Morphed_ico_typlex_ica_equalized_word_Mlttap_new_ctf_Coherence_Gamma_150_450_200ms_' + thislabelname
        print 'gamma'
        coh_stc.save(data_out)
...
# Note: We use a hack to save the frequency axis as time
        ...
        data_out = data_path + meg +  'Morphed_ico_typlex_ica_equalized_word_Mlttap_new_ctf_PPC_Theta_150_450_200ms_' + thislabelname
        print 'theta'
        coh_stc.save(data_out)
        
        coh_stc = mne.SourceEstimate(dw_pli[:,1,:], vertices=stc_coh.vertices, tmin= tmin1, tstep= tstep1, subject='fsaverage')
        data_out = data_path + meg +  'Morphed_ico_typlex_ica_equalized_word_Mlttap_new_ctf_PPC_Alpha_150_450_200ms_' + thislabelname
        print 'alpha'
        coh_stc.save(data_out)
        
        coh_stc = mne.SourceEstimate(dw_pli[:,2,:], vertices=stc_coh.vertices, tmin= tmin1, tstep= tstep1, subject='fsaverage')
        data_out = data_path + meg +  'Morphed_ico_typlex_ica_equalized_word_Mlttap_new_ctf_PPC_Beta_150_450_200ms_' + thislabelname
        print 'beta'
        coh_stc.save(data_out)
        
        coh_stc = mne.SourceEstimate(dw_pli[:,3,:], vertices=stc_coh.vertices, tmin= tmin1, tstep= tstep1, subject='fsaverage')
        data_out = data_path + meg +  'Morphed_ico_typlex_ica_equalized_word_Mlttap_new_ctf_PPC_Gamma_150_450_200ms_' + thislabelname
        print 'gamma'
        coh_stc.save(data_out)
