...
# Load data
    ...
    Matx=stc_to.data[:,:72]# Nv x Nlabels+1
...
#    lambda2 = 1.0 / snr ** 2
    ...
    stc_incoh = data_path + meg + 'firstMorphed_SemLoc_icaclean_Concrete_Source_Evoked_m500_700'
...
#            stc_orig.resample(100)
        ...
        data_out = data_path + meg +  'Morphed_SemLoc_ica_equalized_Concrete_bestV_ctf_MI_Theta_150_450_200ms_' + label1.name[:-3]                                        
        print data_out
        ...
        data_out = data_path + meg +  'Morphed_SemLoc_ica_equalized_Concrete_bestV_ctf_MI_Alpha_150_450_200ms_' + label1.name[:-3]                                        
        print data_out
        ...
        data_out = data_path + meg +  'Morphed_SemLoc_ica_equalized_Concrete_bestV_ctf_MI_Beta_150_450_200ms_' + label1.name[:-3]                                        
        print data_out
        ...
        data_out = data_path + meg +  'Morphed_SemLoc_ica_equalized_Concrete_bestV_ctf_MI_Gamma_150_450_200ms_' + label1.name[:-3]                                        
        print data_out
