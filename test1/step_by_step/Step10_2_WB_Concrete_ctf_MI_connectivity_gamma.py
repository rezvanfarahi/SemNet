...
#  n_cycles[np.logical_and((frequencies>10), (frequencies<=20))] = 3
    ...
    fname_raw = data_path + meg + 'semloc_ssstf_fft_ica_gamma_raw.fif'
...
#            stc_orig.resample(100)
        ...
        data_out = data_path + meg +  'Morphed_ico_SemLoc_ica_equalized_Concrete_new_ctf_MI_Gamma_150_450_200ms_' + thislabelname                                        
        print data_out
