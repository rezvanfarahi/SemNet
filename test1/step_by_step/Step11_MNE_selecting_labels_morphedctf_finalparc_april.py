...
fname_blm='finalpreparc_smooth_stddiff_mergeonly_halfmax'+str(len(balanced_labelsmerge_final))
make_parcellation_mine(src_avg,balanced_labelsmerge_final,clrs[len(balanced_labelssplit_final)/2:,:],subject_avg,fname_blm)

fname_bls='finalpreparc_smooth_stddiff_splitonly_halfmax'+str(len(balanced_labelssplit_final))
make_parcellation_mine(src_avg,balanced_labelssplit_final,clrs[:len(balanced_labelssplit_final)/2,:],subject_avg,fname_bls)

fname_final='finalpostparc_smooth_stddiff_split_merge_halfmax_'+str(len(balanced_labels))
...
col_fname='colour_neuroanat_winnerhem_'+str(len(balanced_labels))+'.mat'
