...
#labellist=[labelatllh,labelifg,labelss[label_index[2]],labelss[label_index[3]],labelss[label_index[4]]]
...
ctfstc_path=data_path+'dcm/stc_ctf_bothm_modlabels_paper'
