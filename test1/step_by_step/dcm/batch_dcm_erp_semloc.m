...
% LogEvd=[]; DCMname={};
this_dir='/imaging/rf02/TypLexMEG/dcm/latest/150ms_32models_2ROIs/semloc';%'/home/rf02/rezvan/test1/step_by_step/dcm/latest/200ms_7models/semloc';
...
parfor s = 1:length(dosubs) %parfor
    ...
    DCMsub = DCMbase;
    fname_a='_SemLoc_Evoked_2ROIs_forDCM';%'_TypLex_Evoked_ATL_WFA_forDCM';
...
%     fname_in=[list_all{s},fname_a,'_cnvrt'];
    ...
    for n=[1,8,16,17,25]%1:numel(Model)
        ...
        n
        DCM      = DCMsub;
        DCM.name = sprintf([this_dir,'/DCM_erp_SemLoc_ATL_WFA_new_sub%d_mod%d.mat'],sub,n);
