...
out_path = '/imaging/rf02/TypLexMEG/dcm/'
...
for ii, meg in enumerate(ll):
    ...
    #        print conind
        ...
        #            np.intersect1d(label_verts,vertices_to[0])
            vert50=np.sort(Matx[label_verts,this_labelc])[-50]
...
#            print winner_verts
        ...
        #            label_data1=np.tile(thisscale,[ntimes,1]).transpose()*label_predata
            ...
            testlabel_path=data_path+'dcm/testDCMoldlabs/new/'+'subject'+str(ii)+'_'+event_name+'_'+this_label.name
...
#    X[ii,:,:,:]=conabs_mat
#    out_file=out_path + meg[:10] + '_SemLoc_Evoked_5ROIs_relCTF_50verts_aifg_forDCM_avg.mat'
