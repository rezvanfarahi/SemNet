...
#        allwin_verts[ii,2*this_labelc+1,:]=rhlabel_verts_subm.copy()
        testlabel_path=data_path+'dcm/testDCMoldlabs/'+'subject'+str(ii)+'_'+this_label.name
...
#    winvert_sub=np.squeeze(allwin_verts[ii,:,:]).copy()
    ...
    #evoked1.resample(50)
    condition1 = apply_inverse(evoked1, inverse_operator_meeg, lambda2, method,pick_ori=None)
    ...
    #evoked2.resample(50)
    condition2 = apply_inverse(evoked2, inverse_operator_meeg, lambda2, method,pick_ori=None)
