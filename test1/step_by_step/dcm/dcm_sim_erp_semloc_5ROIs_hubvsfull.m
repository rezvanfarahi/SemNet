...
% LogEvd=[]; DCMname={};
this_model_dir='/imaging/rf02/TypLexMEG/dcm/5ROIs_hubvsfull/filtered_250ms_28models_5ROIs/semloc/maxCTF_ERP_dtr0/simulated/model1/';%'./16models_200ms/semloc';
out_dir='/imaging/rf02/TypLexMEG/dcm/5ROIs_hubvsfull/filtered_250ms_28models_5ROIs/semloc/maxCTF_ERP_dtr0/simulated/inverted/model1/';
...
parfor s = 1:length(dosubs) %parfor
    ...
    for n=[2,4,39:40,6,8,41:42,10,12,43:44,14,16,45:46,18:2:36,37:38]
        n
%         this_filename=sprintf([this_model_dir,'/DCM_erpf_SemLoc_5ROIs_sub%d_mod%d.mat'],sub,n);
