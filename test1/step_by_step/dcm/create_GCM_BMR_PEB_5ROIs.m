...
clc
close all
addpath('/imaging/local/software/spm_cbu_svn/releases/spm12_latest/')%('/imaging/local/software/spm_cbu_svn/releases/spm12_fil_r6685/')%
...
subj=struct();
GCM={};
dcm_path='/imaging/rf02/TypLexMEG/dcm/5ROIs_hubvsfull/250ms_38models_5ROIs/semloc0/';
...
for s = 1:length(dosubs) %parfor
   ...
   ncnt=0;
    for n=[2,4,39:40]%6,8,41:42,10,12,43:44,14,16,45:46,18:2:36,37:38]%[2:2:36,37:38]%1:38%numel(Model)
        ...
        sub
        n
        load(sprintf([dcm_path,'DCM_erp_SemLoc_5ROIs_sub%d_mod%d.mat'],sub,n));
        GCM{s,ncnt}=DCM;
    end
end
M=struct();
...
out_dir='/imaging/rf02/TypLexMEG/dcm/5ROIs_hubvsfull/250ms_38models_5ROIs/semloc0/';%'/home/rf02/rezvan/test1/step_by_step/dcm/latest/200ms_7models/semloc';
if ~exist(out_dir,'dir')
    mkdir(out_dir)
end
PEB=PEB(1);
outpath='/imaging/rf02/TypLexMEG/dcm/5ROIs_hubvsfull/250ms_38models_5ROIs/semloc0/PEB_full_pebfit_fwdbwd_RCM.mat';
save(outpath,'PEB')  
% save([out_dir,'model_space3.mat'],'subj')
