...
for s = 1:length(dosubs) %parfor
   ...
   ncnt=0;
    for n=[14,16,45:46]%[2,4,39:40]%[30,32]%[2,4,39:40,6,8,41:42,10,12,43:44,14,16,45:46]%,18:2:36,37:38]%[2:2:36,37:38]%1:38%numel(Model)
        ...
        load(sprintf([dcm_path,'DCM_erpf_SemLoc_5ROIs_avg_maxCTF_sub%d_mod%d.mat'],sub,n));%DCM_erpf_SemLoc_5ROIs_mpowavg_sub%d_mod%d.mat
%         DCM_erpf_SemLoc_5ROIs_avg_maxCTF_sub%d_mod%d.mat;;;;DCM_erpf_TypLex_5ROIs_avg_maxCTF_sub%d_mod%d.mat
