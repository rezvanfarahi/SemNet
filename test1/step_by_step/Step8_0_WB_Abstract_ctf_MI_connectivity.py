...
#            stc_orig.resample(100)
        ...
        data_out = data_path + meg +  'Morphed_SemLoc_ica_equalized_Abstract_bestV_ctf_MI_Theta_150_450_200ms_' + label1.name[:-3]                                        
        print data_out
        ...
        data_out = data_path + meg +  'Morphed_SemLoc_ica_equalized_Abstract_bestV_ctf_MI_Alpha_150_450_200ms_' + label1.name[:-3]                                        
        print data_out
        ...
        data_out = data_path + meg +  'Morphed_SemLoc_ica_equalized_Abstract_bestV_ctf_MI_Beta_150_450_200ms_' + label1.name[:-3]                                        
        print data_out
        ...
        data_out = data_path + meg +  'Morphed_SemLoc_ica_equalized_Abstract_bestV_ctf_MI_Gamma_150_450_200ms_' + label1.name[:-3]                                        
        print data_out
