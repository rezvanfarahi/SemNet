...
## epoching
    ...
    data_out = data_path + meg + 'mineMorphed_ico_SemLoc_ica_Concrete_Power_normori_ratio_equalized_m500_700_200hz_' + b
    cp_stc.save(data_out)
    data_out = data_path + meg + 'mineMorphed_ico_SemLoc_ica_Concrete_rPLV_normori_ratio_equalized_m500_700_200hz_' + b
    ...
    data_out = data_path + meg + 'mineMorphed_ico_SemLoc_ica_Abstract_Power_normori_ratio_equalized_m500_700_200hz_' + b
    ap_stc.save(data_out)
    data_out = data_path + meg + 'mineMorphed_ico_SemLoc_ica_Abstract_rPLV_normori_ratio_equalized_m500_700_200hz_' + b
