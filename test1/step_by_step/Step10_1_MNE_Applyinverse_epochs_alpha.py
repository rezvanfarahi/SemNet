...
inv_fname = 'InvOp_ico5diagreg_fft_1_48_clean_ica_EMEG-inv.fif'#'InverseOperator_fft_1_48_clean_ica_EMEG-inv.fif'
...
for ii, meg in enumerate(ll):
    ...
    raw_fname = data_path + meg + 'semloc_ssstf_fft_ica_alpha_raw.fif' #clean_ssp_
    ...
    for ccc, con1 in enumerate(condition1):
        ...
        data_out1 = data_path + meg + 'Morphed_ico_SemLoc_epochs' + str(ccc) + '_icaclean_Concrete_Source_Alpha_m500_700'
    ...
    for ccc, con2 in enumerate(condition2):
        ...
        data_out2 = data_path + meg + 'Morphed_ico_SemLoc_epochs' + str(ccc) + '_icaclean_Abstract_Source_Alpha_m500_700'
