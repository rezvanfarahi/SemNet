...
for b in bands:
	print b
	fname0 = data_path + ll[0] + 'Morphed_TypLex_PW_AtypPWords_Power_logratio_m500_700_' + b  
	stc0 = mne.read_source_estimate(fname0)

	fname1 = data_path + ll[1] + 'Morphed_TypLex_PW_AtypPWords_Power_logratio_m500_700_' + b  
	stc1 = mne.read_source_estimate(fname1)

	fname2 = data_path + ll[2] + 'Morphed_TypLex_PW_AtypPWords_Power_logratio_m500_700_' + b  
	stc2 = mne.read_source_estimate(fname2)

	fname3 = data_path + ll[3] + 'Morphed_TypLex_PW_AtypPWords_Power_logratio_m500_700_' + b  
	stc3 = mne.read_source_estimate(fname3)

	fname4 = data_path + ll[4] + 'Morphed_TypLex_PW_AtypPWords_Power_logratio_m500_700_' + b  
	stc4 = mne.read_source_estimate(fname4)

	fname5 = data_path + ll[5] + 'Morphed_TypLex_PW_AtypPWords_Power_logratio_m500_700_' + b  
	stc5 = mne.read_source_estimate(fname5)

	fname6 = data_path + ll[6] + 'Morphed_TypLex_PW_AtypPWords_Power_logratio_m500_700_' + b  
	stc6 = mne.read_source_estimate(fname6)

	fname7 = data_path + ll[7] + 'Morphed_TypLex_PW_AtypPWords_Power_logratio_m500_700_' + b  
	stc7 = mne.read_source_estimate(fname7)

	fname8 = data_path + ll[8] + 'Morphed_TypLex_PW_AtypPWords_Power_logratio_m500_700_' + b  
	stc8 = mne.read_source_estimate(fname8)

	fname9 = data_path + ll[9] + 'Morphed_TypLex_PW_AtypPWords_Power_logratio_m500_700_' + b  
	stc9 = mne.read_source_estimate(fname9)

	fname10 = data_path + ll[10] + 'Morphed_TypLex_PW_AtypPWords_Power_logratio_m500_700_' + b  
	stc10 = mne.read_source_estimate(fname10)

	fname11 = data_path + ll[11] + 'Morphed_TypLex_PW_AtypPWords_Power_logratio_m500_700_' + b  
	stc11 = mne.read_source_estimate(fname11)

	fname12 = data_path + ll[12] + 'Morphed_TypLex_PW_AtypPWords_Power_logratio_m500_700_' + b  
	stc12 = mne.read_source_estimate(fname12)

	fname13 = data_path + ll[13] + 'Morphed_TypLex_PW_AtypPWords_Power_logratio_m500_700_' + b  
	stc13 = mne.read_source_estimate(fname13)

	fname14 = data_path + ll[14] + 'Morphed_TypLex_PW_AtypPWords_Power_logratio_m500_700_' + b  
	stc14 = mne.read_source_estimate(fname14)

	fname15 = data_path + ll[15] + 'Morphed_TypLex_PW_AtypPWords_Power_logratio_m500_700_' + b  
	...
	out_file=data_path + 'GrandAverage_TypLex_PW_AtypPWords_Power_logratio_m500_700_' + b  
