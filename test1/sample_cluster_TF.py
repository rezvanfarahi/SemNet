# -*- coding: utf-8 -*-
"""
Created on Mon May 18 11:33:34 2015
...
epochs_power = mne.time_frequency.single_trial_power(data, sfreq=Fs, frequencies=frequencies,n_cycles=4, use_fft=False, n_jobs=1,baseline=(-100, 0), times=times, baseline_mode='ratio', decim=decim)
...
T_obs, clusters, cluster_p_values, H0 = \
                   permutation_cluster_1samp_test(epochs_power, n_permutations=100, threshold=threshold, tail=0)
