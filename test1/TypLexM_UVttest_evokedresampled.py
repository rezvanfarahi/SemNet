...
for ii, meg in enumerate(ll):
	print ii
	fname_c = data_path + meg +  'firstMorphed_SemLoc_icaclean_Concrete_Source_Evoked_meanresampled_50_550_100ms_0overlap'
	stc_c = mne.read_source_estimate(fname_c)

	fname_a = data_path + meg +  'firstMorphed_SemLoc_icaclean_Abstract_Source_Evoked_meanresampled_50_550_100ms_0overlap'
...
out_file=out_path + 'UVttest_firstMorphed_SemLoc_icaclean_Subtract_Source_Evoked_meanresampled_50_550_100ms_0overlap'
