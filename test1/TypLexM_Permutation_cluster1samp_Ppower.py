...
### Concrete
	fname_cncrt = data_path + meg + 'Morphed_SemLoc_sspclean_Concrete_Power_ratio_m500_700_theta'
	stc_cncrt = mne.read_source_estimate(fname_cncrt)
	fname_abs = data_path + meg + 'Morphed_SemLoc_sspclean_Abstract_Power_ratio_m500_700_theta'
	...
	abslt_cncrt= stc_cncrt.copy().crop(0.3,0.5).data.mean(axis=1)
	abslt_abs= stc_abs.copy().crop(0.3,0.5).data.mean(axis=1)
	data_subtract=np.subtract(abslt_cncrt,abslt_abs)
	X1[:,ii]=data_subtract
	"""
...
t0, c0, p0, h0= mne.stats.permutation_cluster_1samp_test(X0, connectivity=connectivity, n_jobs=2, threshold=t_threshold)
print "per1 done"
...
stc_all_cluster_vis = summarize_clusters_stc(clu, tstep=tstep,
                                     ...
                                     subject='average')
"""
out_file1=data_path + 'Permutation_ttest_pmap_SemLoc_ConcreteAbstract_SourcePower_ratio_m500_700_Theta' 
p_stc.save(out_file1)
out_file2=data_path + 'Permutation_ttest_tmap_SemLoc_ConcreteAbstract_SourcePower_ratio_m500_700_Theta' 
