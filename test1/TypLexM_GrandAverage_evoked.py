...
#fname0 = data_path + ll[0] + 'firstMorphed_SemLoc_icaclean_Abstract_Source_Evoked_unequalized_m500_700'  
#stc0 = mne.read_source_estimate(fname0)
#
#fname1 = data_path + ll[1] + 'firstMorphed_SemLoc_icaclean_Abstract_Source_Evoked_unequalized_m500_700'  
#stc1 = mne.read_source_estimate(fname1)
#
#fname2 = data_path + ll[2] + 'firstMorphed_SemLoc_icaclean_Abstract_Source_Evoked_unequalized_m500_700'  
#stc2 = mne.read_source_estimate(fname2)
#
#fname3 = data_path + ll[3] + 'firstMorphed_SemLoc_icaclean_Abstract_Source_Evoked_unequalized_m500_700'  
#stc3 = mne.read_source_estimate(fname3)
#
#fname4 = data_path + ll[4] + 'firstMorphed_SemLoc_icaclean_Abstract_Source_Evoked_unequalized_m500_700'  
#stc4 = mne.read_source_estimate(fname4)
#
#fname5 = data_path + ll[5] + 'firstMorphed_SemLoc_icaclean_Abstract_Source_Evoked_unequalized_m500_700'  
#stc5 = mne.read_source_estimate(fname5)
#
#fname6 = data_path + ll[6] + 'firstMorphed_SemLoc_icaclean_Abstract_Source_Evoked_unequalized_m500_700'  
#stc6 = mne.read_source_estimate(fname6)
#
#fname7 = data_path + ll[7] + 'firstMorphed_SemLoc_icaclean_Abstract_Source_Evoked_unequalized_m500_700'  
#stc7 = mne.read_source_estimate(fname7)
#
#fname8 = data_path + ll[8] + 'firstMorphed_SemLoc_icaclean_Abstract_Source_Evoked_unequalized_m500_700'  
#stc8 = mne.read_source_estimate(fname8)
#
#fname9 = data_path + ll[9] + 'firstMorphed_SemLoc_icaclean_Abstract_Source_Evoked_unequalized_m500_700'  
#stc9 = mne.read_source_estimate(fname9)
#
#fname10 = data_path + ll[10] + 'firstMorphed_SemLoc_icaclean_Abstract_Source_Evoked_unequalized_m500_700'  
#stc10 = mne.read_source_estimate(fname10)
#
#fname11 = data_path + ll[11] + 'firstMorphed_SemLoc_icaclean_Abstract_Source_Evoked_unequalized_m500_700'  
#stc11 = mne.read_source_estimate(fname11)
#
#fname12 = data_path + ll[12] + 'firstMorphed_SemLoc_icaclean_Abstract_Source_Evoked_unequalized_m500_700'  
#stc12 = mne.read_source_estimate(fname12)
#
#fname13 = data_path + ll[13] + 'firstMorphed_SemLoc_icaclean_Abstract_Source_Evoked_unequalized_m500_700'  
#stc13 = mne.read_source_estimate(fname13)
#
#fname14 = data_path + ll[14] + 'firstMorphed_SemLoc_icaclean_Abstract_Source_Evoked_unequalized_m500_700'  
#stc14 = mne.read_source_estimate(fname14)
#
#fname15 = data_path + ll[15] + 'firstMorphed_SemLoc_icaclean_Abstract_Source_Evoked_unequalized_m500_700'  
#stc15 = mne.read_source_estimate(fname15)
#
#fname16 = data_path + ll[16] + 'firstMorphed_SemLoc_icaclean_Abstract_Source_Evoked_unequalized_m500_700'  
...
#out_file=out_path + 'GrandAverage_firsmorphed_SemLoc_icaclean_Abstract_Source_Evoked_unequalized_m500_700'
...
out_file1=out_path + 'GrandAverage_firsmorphed_SemLoc_icaclean_Concrete_Source_Evoked_unequalized_m500_700'  
stcs1 = mne.read_source_estimate(out_file1)
out_file2=out_path + 'GrandAverage_firsmorphed_SemLoc_icaclean_Abstract_Source_Evoked_unequalized_m500_700' 
stcs2 = mne.read_source_estimate(out_file2)
stc_subtract=np.subtract(stcs1,stcs2)
out_file=out_path + 'GrandAverage_firsmorphed_SemLoc_icaclean_Subtract_Source_Evoked_unequalized_m500_700' 
