...
for meg in ll:
	...
	for label_name in labellist:
		...
		fname = data_path + meg + 'SemLoc_Concrete_Coherence_AlphaBeta_150_350_' + label_name[0:-3]
		...
		out_file=data_path + meg + 'Morphed_SemLoc_Concrete_Coherence_AlphaBeta_150_350_' + label_name[0:-3]
