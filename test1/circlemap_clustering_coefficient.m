...
%     
%     plv_matcr=zeros(size(plv_matc,1),size(plv_matc,2),size(plv_matc,3),10);
%     plv_matar=zeros(size(plv_mata,1),size(plv_mata,2),size(plv_mata,3),10);
%     plv_matbr=zeros(size(plv_matb,1),size(plv_matb,2),size(plv_matb,3),10);
%     for ii=1:10
...
%     save([in_path,list_all{cnt},'thresholded_15_pca_coh_abstract_resampled_10win.mat'],'thresh_a')
%     save([in_path,list_all{cnt},'thresholded_15_pca_coh_concrete_resampled_10win.mat'],'thresh_c')
%     save([in_path,list_all{cnt},'thresholded_15_pca_coh_both_resampled_10win.mat'],'thresh_b')
%     
%     save([in_path,list_all{cnt},'degrees_proportional_15_pca_coh_abstract_resampled_10win.mat'],'deg_ar')
%     save([in_path,list_all{cnt},'degrees_proportional_15_pca_coh_concrete_resampled_10win.mat'],'deg_cr')
%     save([in_path,list_all{cnt},'degrees_proportional_15_pca_coh_both_resampled_10win.mat'],'deg_br')
%     save([in_path,list_all{cnt},'nodestrength_15_pca_coh_abstract_resampled_10win.mat'],'strength_a')
%     save([in_path,list_all{cnt},'nodestrength_15_pca_coh_concrete_resampled_10win.mat'],'strength_c')
    %         save([in_path,list_all{cnt},'degree_mean_pca_coh_abstract.mat'],'deg_a')
    %         save([in_path,list_all{cnt},'degree_mean_pca_coh_concrete.mat'],'deg_c')
    %         save([in_path,list_all{cnt},'degree_absthresh_plv_subtract.mat'],'deg_s')
    
    %
    load([in_path,list_all{cnt},'degrees_proportional_15_pca_coh_concrete_resampled_10win.mat'])
    load([in_path,list_all{cnt},'degrees_proportional_15_pca_coh_abstract_resampled_10win.mat'])
%     load([in_path,list_all{cnt},'degrees_proportional_15_pca_coh_both_resampled.mat'])
...
deg_mean=mean(deg_brtr(:,:,2:2:10,:),4);
...
deg_bzmz=deg_brtzrm(:,:,2:2:10);
deg_bzmz(deg_final<0)=0;
%deg_final=deg_mean;
%deg_final(deg_p==0)=0;
out_path='/imaging/rf02/TypLexMEG/icaanalysis_results/jpg/time_resolved/ROI_connectivity/graph/coh_degrees_15_resampled_10win_bothcon2_hubs_prob.mat';
save(out_path,'deg_final')
% out_path='/imaging/rf02/TypLexMEG/icaanalysis_results/jpg/time_resolved/ROI_connectivity/graph/coh_degrees_zmz_15_resampled_10win_bothcon2_hubs.mat';
% save(out_path,'deg_bzmz')
out_path='/imaging/rf02/TypLexMEG/icaanalysis_results/jpg/time_resolved/ROI_connectivity/graph/coh_degrees_prob_15_resampled_10win_bothcon2_hubs.mat';
save(out_path,'deg_p')

deg_pca=deg_brtr(:,:,2:2:10,:);
cc=0;
deg_pcaf=[];
