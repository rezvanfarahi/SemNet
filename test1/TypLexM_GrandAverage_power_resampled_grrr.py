...
fname0 = data_path + ll[0] + 'Morphed_SemLoc_icaclean_Abstract_Power_ratio_m500_700_theta'  
...
Matx0=np.divide(Matx0,Matx0.max(axis=0))
matx_stc0 = mne.SourceEstimate(Matx0, vertices=vertices_to,tmin=1e-3 * tmin1, tstep=1e-3 * tstep1, subject='avgsubj')



fname1 = data_path + ll[1] + 'Morphed_SemLoc_icaclean_Abstract_Power_ratio_m500_700_theta'  
...
Matx1=np.divide(Matx1,Matx1.max(axis=0))
...
fname2 = data_path + ll[2] + 'Morphed_SemLoc_icaclean_Abstract_Power_ratio_m500_700_theta'  
...
Matx2=np.divide(Matx2,Matx2.max(axis=0))
...
fname3 = data_path + ll[3] + 'Morphed_SemLoc_icaclean_Abstract_Power_ratio_m500_700_theta'  
...
Matx3=np.divide(Matx3,Matx3.max(axis=0))
...
fname4 = data_path + ll[4] + 'Morphed_SemLoc_icaclean_Abstract_Power_ratio_m500_700_theta'  
...
Matx4=np.divide(Matx4,Matx4.max(axis=0))
...
fname5 = data_path + ll[5] + 'Morphed_SemLoc_icaclean_Abstract_Power_ratio_m500_700_theta'  
...
Matx5=np.divide(Matx5,Matx5.max(axis=0))
...
fname6 = data_path + ll[6] + 'Morphed_SemLoc_icaclean_Abstract_Power_ratio_m500_700_theta'  
...
Matx6=np.divide(Matx6,Matx6.max(axis=0))
matx_stc6 = mne.SourceEstimate(Matx6, vertices=vertices_to,tmin=1e-3 * tmin1, tstep=1e-3 * tstep1, subject='avgsubj')
		

print "6 finished!"

fname7 = data_path + ll[7] + 'Morphed_SemLoc_icaclean_Abstract_Power_ratio_m500_700_theta'  
...
Matx7=np.divide(Matx7,Matx7.max(axis=0))
...
fname8 = data_path + ll[8] + 'Morphed_SemLoc_icaclean_Abstract_Power_ratio_m500_700_theta'  
...
Matx8=np.divide(Matx8,Matx8.max(axis=0))
...
fname9 = data_path + ll[9] + 'Morphed_SemLoc_icaclean_Abstract_Power_ratio_m500_700_theta'  
...
Matx9=np.divide(Matx9,Matx9.max(axis=0))
...
fname10 = data_path + ll[10] + 'Morphed_SemLoc_icaclean_Abstract_Power_ratio_m500_700_theta'  
...
Matx10=np.divide(Matx10,Matx10.max(axis=0))
...
fname11 = data_path + ll[11] + 'Morphed_SemLoc_icaclean_Abstract_Power_ratio_m500_700_theta'  
...
Matx11=np.divide(Matx11,Matx11.max(axis=0))
...
fname12 = data_path + ll[12] + 'Morphed_SemLoc_icaclean_Abstract_Power_ratio_m500_700_theta'  
...
Matx12=np.divide(Matx12,Matx12.max(axis=0))
matx_stc12 = mne.SourceEstimate(Matx12, vertices=vertices_to,tmin=1e-3 * tmin1, tstep=1e-3 * tstep1, subject='avgsubj')
		

print "12 finished!"

fname13 = data_path + ll[13] + 'Morphed_SemLoc_icaclean_Abstract_Power_ratio_m500_700_theta'  
...
Matx13=np.divide(Matx13,Matx13.max(axis=0))
matx_stc13 = mne.SourceEstimate(Matx13, vertices=vertices_to,tmin=1e-3 * tmin1, tstep=1e-3 * tstep1, subject='avgsubj')
		

print "13 finished!"

fname14 = data_path + ll[14] + 'Morphed_SemLoc_icaclean_Abstract_Power_ratio_m500_700_theta'  
...
Matx14=np.divide(Matx14,Matx14.max(axis=0))
matx_stc14 = mne.SourceEstimate(Matx14, vertices=vertices_to,tmin=1e-3 * tmin1, tstep=1e-3 * tstep1, subject='avgsubj')
		

print "14 finished!"

fname15 = data_path + ll[15] + 'Morphed_SemLoc_icaclean_Abstract_Power_ratio_m500_700_theta'  
...
Matx15=np.divide(Matx15,Matx15.max(axis=0))
...
fname16 = data_path + ll[16] + 'Morphed_SemLoc_icaclean_Abstract_Power_ratio_m500_700_theta'  
...
Matx16=np.divide(Matx16,Matx16.max(axis=0))
...
stc_grand=np.mean([matx_stc0,matx_stc1,matx_stc2,matx_stc3,matx_stc4,matx_stc5,matx_stc6,matx_stc7,matx_stc8,matx_stc9,matx_stc10,matx_stc11,matx_stc12,matx_stc13,matx_stc14,matx_stc15,matx_stc16])
...
out_file=out_path + 'GrandAverage_SemLoc_icaclean_Abstract_SourcePower_ratio_theta_meanresampled_normalised_50_550_100ms'
...
in_file2=out_path + 'GrandAverage_SemLoc_icaclean_Subtract_SourcePower_ratio_m500_700_theta' 
stc2=mne.read_source_estimate(in_file2) 
in_file3=out_path + 'GrandAverage_SemLoc_icaclean_Subtract_SourcePower_ratio_m500_700_theta'  
stc3=mne.read_source_estimate(in_file3)
in_file4=out_path + 'GrandAverage_SemLoc_icaclean_Subtract_SourcePower_ratio_m500_700_theta'  
stc4=mne.read_source_estimate(in_file4)
plt.plot(stc1.times[100:1100], stc1.data[:,100:1100].mean(axis=0), label='theta')
plt.plot(stc2.times[100:1100], stc2.data[:,100:1100].mean(axis=0), label='theta')
plt.plot(stc3.times[100:1100], stc3.data[:,100:1100].mean(axis=0), label='theta')
plt.plot(stc4.times[100:1100], stc4.data[:,100:1100].mean(axis=0), label='theta')
plt.xlabel('Time (ms)')
plt.ylabel('Power')
plt.legend()
...
"""
out_file1=out_path + 'GrandAverage_SemLoc_icaclean_Concrete_SourcePower_ratio_gamma_meanresampled_normalised_50_550_100ms'
stcs1 = mne.read_source_estimate(out_file1)
out_file2=out_path + 'GrandAverage_SemLoc_icaclean_Abstract_SourcePower_ratio_gamma_meanresampled_normalised_50_550_100ms'
stcs2 = mne.read_source_estimate(out_file2)
stc_subtract=np.subtract(stcs1,stcs2)
out_file=out_path + 'GrandAverage_SemLoc_icaclean_Subtract_SourcePower_ratio_gamma_meanresampled_normalised_50_550_100ms'
