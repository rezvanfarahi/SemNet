...
### Concrete
		fname_cncrt = data_path + meg + 'Morphed_SemLoc_icaclean_Concrete_PhaseLocking_ThetaAlphaBetaGamma_150_350_' + label_name[0:-3]
		stc_cncrt = mne.read_source_estimate(fname_cncrt)
		fname_abs = data_path + meg + 'Morphed_SemLoc_icaclean_Abstract_PhaseLocking_ThetaAlphaBetaGamma_150_350_' + label_name[0:-3]
	...
	tstep=1e-3
	fsave_vertices = [np.arange(10242), np.arange(10242)]
	p_thresh=0.047#cluster_p_valuest.min()+0.001
	print good_cluster_indst
	stc_all_cluster_vist = summarize_clusters_stc(clut, tstep=tstep, p_thresh=0.05, vertno=fsave_vertices, subject='avgsubj')
	out_file1=data_path + 'Permutation_SemLoc_icaclean_Concrete_PhaseLocking_Theta_150_350_pnt' + str(p_thresh)[2:5] + '_' + label_name[0:-3]
	...
	out_file1=data_path + 'Permutation_SemLoc_icaclean_Concrete_PhaseLocking_Alpha_150_350_pnt' + str(p_thresh)[2:4] + '_' + label_name[0:-3]
	stc_all_cluster_visa.save(out_file1)
	"""
	p_thresh=0.047#cluster_p_valuesb.min()+0.001
	print good_cluster_indsb
	stc_all_cluster_visb = summarize_clusters_stc(club, tstep=tstep, p_thresh=0.05, vertno=fsave_vertices, subject='avgsubj')
	out_file1=data_path + 'Permutation_SemLoc_icaclean_Concrete_PhaseLocking_Beta_150_350_pnt' + str(p_thresh)[2:5] + '_' + label_name[0:-3]
	...
	out_file1=data_path + 'Permutation_SemLoc_icaclean_Concrete_PhaseLocking_Gamma_150_350_pnt' + str(p_thresh)[2:4] + '_' + label_name[0:-3]
