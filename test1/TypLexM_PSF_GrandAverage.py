...
fname0 = data_path + ll[0] + 'psf_eegmeg'
stc0 = mne.read_source_estimate(fname0)

fname1 = data_path + ll[1] + 'psf_eegmeg'
stc1 = mne.read_source_estimate(fname1)

fname2 = data_path + ll[2] + 'psf_eegmeg'
stc2 = mne.read_source_estimate(fname2)

fname3 = data_path + ll[3] + 'psf_eegmeg'
stc3 = mne.read_source_estimate(fname3)

fname4 = data_path + ll[4] + 'psf_eegmeg'
stc4 = mne.read_source_estimate(fname4)

#fname5 = data_path + ll[5] + 'psf_eegmeg'
#stc5 = mne.read_source_estimate(fname5)

fname6 = data_path + ll[6] + 'psf_eegmeg'
stc6 = mne.read_source_estimate(fname6)

fname7 = data_path + ll[7] + 'psf_eegmeg'
stc7 = mne.read_source_estimate(fname7)

fname8 = data_path + ll[8] + 'psf_eegmeg'
stc8 = mne.read_source_estimate(fname8)

fname9 = data_path + ll[9] + 'psf_eegmeg'
stc9 = mne.read_source_estimate(fname9)

fname10 = data_path + ll[10] + 'psf_eegmeg'
stc10 = mne.read_source_estimate(fname10)

fname11 = data_path + ll[11] + 'psf_eegmeg'
stc11 = mne.read_source_estimate(fname11)

fname12 = data_path + ll[12] + 'psf_eegmeg'
stc12 = mne.read_source_estimate(fname12)

fname13 = data_path + ll[13] + 'psf_eegmeg'
stc13 = mne.read_source_estimate(fname13)

fname14 = data_path + ll[14] + 'psf_eegmeg'
stc14 = mne.read_source_estimate(fname14)

fname15 = data_path + ll[15] + 'psf_eegmeg'
stc15 = mne.read_source_estimate(fname15)

fname16 = data_path + ll[16] + 'psf_eegmeg'
stc16 = mne.read_source_estimate(fname16)

stc_grand=np.mean([stc0,stc1,stc2,stc3,stc4,stc6,stc7,stc8,stc9,stc10,stc11,stc12,stc13,stc14,stc15,stc16])
out_file=data_path + 'GrandAverage_SemLoc_PSF_EMEG'
...
import matplotlib.pyplot as plt
in_file1=data_path + 'GrandAverage_SemLoc_Concrete_SourcePower_m500_700beta'  
stc1=mne.read_source_estimate(in_file1)
in_file2=data_path + 'GrandAverage_SemLoc_Concrete_SourcePower_m500_700beta' 
stc2=mne.read_source_estimate(in_file2) 
in_file3=data_path + 'GrandAverage_SemLoc_Concrete_SourcePower_m500_700beta'  
stc3=mne.read_source_estimate(in_file3)
in_file4=data_path + 'GrandAverage_SemLoc_Concrete_SourcePower_m500_700gamma'  
stc4=mne.read_source_estimate(in_file4)
plt.plot(stc1.times[200:900], stc1.data[:,200:900].mean(axis=0), label='beta')
plt.plot(stc2.times[200:900], stc2.data[:,200:900].mean(axis=0), label='beta')
plt.plot(stc3.times[200:900], stc3.data[:,200:900].mean(axis=0), label='beta')
plt.plot(stc4.times[200:900], stc4.data[:,200:900].mean(axis=0), label='gamma')
plt.xlabel('Time (ms)')
plt.ylabel('Power')
plt.legend()
...
"""
out_file1=data_path + 'GrandAverage_SemLoc_Concrete_SourcePower_m500_700beta'  
stcs1 = mne.read_source_estimate(out_file1)
out_file2=data_path + 'GrandAverage_SemLoc_Abstract_SourcePower_m500_700beta' 
stcs2 = mne.read_source_estimate(out_file2)
stc_subtract=np.subtract(stcs1,stcs2)
out_file=data_path + 'GrandAverage_SemLoc_Subtract_SourcePower_m500_700beta'  
