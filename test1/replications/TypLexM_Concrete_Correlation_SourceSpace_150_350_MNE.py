...
# Generate index parameter for seed-based connectivity analysis
		...
		data_out = data_path + meg +  'Morphed_SemLoc_icaclean_Abstract_Correlation_150_650_200ms' + label_name[0:-3]
		
		corr_stc.save(data_out)
		p_stc = mne.SourceEstimate(Rc, vertices=stcs.vertno, tmin=1e-3 * tmin1, tstep=1e-3 * tstep1, subject='avgsubj')
		data_out = data_path + meg +  'Morphed_SemLoc_icaclean_Abstract_Correlation_pvalues_150_650_200ms' + label_name[0:-3]
		p_stc.save(data_out)
############
