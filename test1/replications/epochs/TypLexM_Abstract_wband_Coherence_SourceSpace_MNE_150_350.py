...
# Note: We use a hack to save the frequency axis as time
        ...
        data_out = data_path + meg +  'firstMorphed_SemLoc_icaclean_equalized_Abstract_Coherence_WholeBand_150_350_' + label_name[0:-3]
        print data_out
...
#        data_out = data_path + meg +  'firstMorphed_SemLoc_icaclean_equalized_Abstract_PLV_WholeBand_150_350_' + label_name[0:-3]
#        print data_out
...
###############
	print "spectral connectivity ppc"
        ...
        tstep1 = 1#np.mean(freqs[1]) - tmin
        plv_stc = mne.SourceEstimate(plv, vertices=stc_coh.vertices, tmin=1e-3 * tmin1, tstep=1e-3 * tstep1, subject='fsaverage')
        data_out = data_path + meg +  'firstMorphed_SemLoc_icaclean_equalized_Abstract_PPC_WholeBand_150_350_' + label_name[0:-3]
        print data_out
        plv_stc.save(data_out)
