...
for p_threshold in ll:
    ...
    ### Concrete
        	...
        	fname_cncrt = data_path + meg + 'mineMorphed_ico_SemLoc_ica_Concrete_rPLV_normori_ratio_equalized_m500_700_200hz_' +thisband#'mineMorphed_ico_SemLoc_icaclean_Concrete_rPLV_ratio_equalized_m500_700_' + b
        	stc_cncrt = mne.read_source_estimate(fname_cncrt)
        	#abslt_cncrt= np.absolute(stc_cncrt.copy().crop(.3,.4).data)
        	fname_abs = data_path + meg + 'mineMorphed_ico_SemLoc_ica_Abstract_rPLV_normori_ratio_equalized_m500_700_200hz_' +thisband#'mineMorphed_ico_SemLoc_icaclean_Abstract_rPLV_ratio_equalized_m500_700_' + b
...
#    print cluster_p_values.min()
    ...
    if cluster_p_values.min()<=0.05:#clus_p_values.min()<=0.01 and cluster_p_values.min()<=0.1:
        ...
        out_file1=out_path + 'Per_clusp'+str(p_threshold)[2:]+'_p'+str(cluster_p_values.min())[2:]+'_SL_ica_Subtract_rPLV_ratio_ico_normori_eq_50_550_100ms_sx_ms' + str(max_step) +'allbands'
        ...
        out_file2=out_path + 'Per_sw_clusp'+str(p_threshold)[2:]+'_p'+str(p_thresh)[2:]+'_SL_ica_Subtract_rPLV_ratio_normori_eq_50_550_100ms_sx_ms' + str(max_step) +'allbands'
