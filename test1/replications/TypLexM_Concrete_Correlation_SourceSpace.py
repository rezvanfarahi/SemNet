...
for cntt, meg in enumerate(ll):
	...
	sct_in = data_path + meg + 'firstMorphed_SemLoc_icaclean_Abstract_Source_Evoked_m500_700'
...
# Generate index parameter for seed-based connectivity analysis
		...
		data_out = data_path + meg +  'firstMorphed_SemLoc_icaclean_Abstract_Correlation_150_450_200ms' + label_name[0:-3]
		...
		data_out = data_path + meg +  'firstMorphed_SemLoc_icaclean_Abstract_Correlation_pvalues_150_450_200ms' + label_name[0:-3]
		p_stc.save(data_out)
############
