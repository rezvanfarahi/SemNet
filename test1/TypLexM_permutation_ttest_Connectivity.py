...
### Concrete
		fname_cncrt = data_path + meg + 'Morphed_SemLoc_Concrete_PhaseLocking_AlphaBeta_150_350_' + label_name[0:-3]
		stc_cncrt = mne.read_source_estimate(fname_cncrt)
		fname_abs = data_path + meg + 'Morphed_SemLoc_Abstract_PhaseLocking_AlphaBeta_150_350_' + label_name[0:-3]
	...
	t_theta, p_theta, h_theta= mne.stats.permutation_t_test(X_theta, n_permutations=1024, tail=0, n_jobs=1, verbose=None)
	print "per1 done"
	t_alpha, p_alpha, h_alpha = mne.stats.permutation_t_test(X_alpha, n_permutations=1024, tail=0, n_jobs=1, verbose=None)
	print "per2 done"
	t_beta, p_beta, h_beta = mne.stats.permutation_t_test(X_beta, n_permutations=1024, tail=0, n_jobs=1, verbose=None)
	print "per3 done"
	t_gamma, p_gamma, h_gamma = mne.stats.permutation_t_test(X_gamma, n_permutations=1024, tail=0, n_jobs=1, verbose=None)
	print "per4 done"
	...
	t_stc = mne.SourceEstimate(t_map, vertices=fsave_vertices, tmin=1e-3*2, tstep=1e-3*2, subject='avgsubject', verbose=None)
	print "se1 done"
	...
	stc_all_cluster_vis = summarize_clusters_stc(clu, tstep=tstep,
                                             ...
                                             subject='average')
	"""
	out_file1=data_path + 'Permutation_ttest_pmap_SemLoc_ConcreteAbstract_PhaseLocking_ThetaAlphaBetaGamma_150_350_' + label_name[0:-3]
	p_stc.save(out_file1)
	#out_file2=data_path + 'Permutation_pmap_SemLoc_ConcreteAbstract_PhaseLocking_ThetaAlphaBetaGamma_150_350_' + label_name[0:-3]
	#p_stc.save(out_file2)
	#out_file3=data_path + 'Permutation_tmap_SemLoc_ConcreteAbstract_PhaseLocking_Beta_150_350_' + label_name[0:-3]
	#t_beta_stc.save(out_file3)
	#out_file4=data_path + 'Permutation_pmap_SemLoc_ConcreteAbstract_PhaseLocking_Beta_150_350_' + label_name[0:-3]
	...
	#fig_out = data_path + label_name[0:-3] + '_TEST_PhaseLocking.jpg'
	#brain.show_view('lateral')
	#brain.save_image(fig_out)


"""
		fname_cncrt1 = data_path + ll[1] + 'Morphed_SemLoc_Concrete_PhaseLocking_AlphaBeta_150_350_' + label_name[0:-3]
		stc_cncrt1 = mne.read_source_estimate(fname_cncrt1)

		fname_cncrt2 = data_path + ll[2] + 'Morphed_SemLoc_Concrete_PhaseLocking_AlphaBeta_150_350_' + label_name[0:-3]
		stc_cncrt2 = mne.read_source_estimate(fname_cncrt2)

		fname_cncrt3 = data_path + ll[3] + 'Morphed_SemLoc_Concrete_PhaseLocking_AlphaBeta_150_350_' + label_name[0:-3]
		stc_cncrt3 = mne.read_source_estimate(fname_cncrt3)

		fname_cncrt4 = data_path + ll[4] + 'Morphed_SemLoc_Concrete_PhaseLocking_AlphaBeta_150_350_' + label_name[0:-3]
		stc_cncrt4 = mne.read_source_estimate(fname_cncrt4)

		fname_cncrt5 = data_path + ll[5] + 'Morphed_SemLoc_Concrete_PhaseLocking_AlphaBeta_150_350_' + label_name[0:-3]
		stc_cncrt5 = mne.read_source_estimate(fname_cncrt5)

		fname_cncrt6 = data_path + ll[6] + 'Morphed_SemLoc_Concrete_PhaseLocking_AlphaBeta_150_350_' + label_name[0:-3]
		stc_cncrt6 = mne.read_source_estimate(fname_cncrt6)

		fname_cncrt7 = data_path + ll[7] + 'Morphed_SemLoc_Concrete_PhaseLocking_AlphaBeta_150_350_' + label_name[0:-3]
		stc_cncrt7 = mne.read_source_estimate(fname_cncrt7)

		fname_cncrt8 = data_path + ll[8] + 'Morphed_SemLoc_Concrete_PhaseLocking_AlphaBeta_150_350_' + label_name[0:-3]
		stc_cncrt8 = mne.read_source_estimate(fname_cncrt8)

		fname_cncrt9 = data_path + ll[9] + 'Morphed_SemLoc_Concrete_PhaseLocking_AlphaBeta_150_350_' + label_name[0:-3]
		stc_cncrt9 = mne.read_source_estimate(fname_cncrt9)

		fname_cncrt10 = data_path + ll[10] + 'Morphed_SemLoc_Concrete_PhaseLocking_AlphaBeta_150_350_' + label_name[0:-3]
		stc_cncrt10 = mne.read_source_estimate(fname_cncrt10)

		fname_cncrt11 = data_path + ll[11] + 'Morphed_SemLoc_Concrete_PhaseLocking_AlphaBeta_150_350_' + label_name[0:-3]
		stc_cncrt11 = mne.read_source_estimate(fname_cncrt11)

		fname_cncrt12 = data_path + ll[12] + 'Morphed_SemLoc_Concrete_PhaseLocking_AlphaBeta_150_350_' + label_name[0:-3]
		stc_cncrt12 = mne.read_source_estimate(fname_cncrt12)

		fname_cncrt13 = data_path + ll[13] + 'Morphed_SemLoc_Concrete_PhaseLocking_AlphaBeta_150_350_' + label_name[0:-3]
		stc_cncrt13 = mne.read_source_estimate(fname_cncrt13)

		fname_cncrt14 = data_path + ll[14] + 'Morphed_SemLoc_Concrete_PhaseLocking_AlphaBeta_150_350_' + label_name[0:-3]
		stc_cncrt14 = mne.read_source_estimate(fname_cncrt14)

		fname_cncrt15 = data_path + ll[15] + 'Morphed_SemLoc_Concrete_PhaseLocking_AlphaBeta_150_350_' + label_name[0:-3]
		stc_cncrt15 = mne.read_source_estimate(fname_cncrt15)

		fname_cncrt16 = data_path + ll[16] + 'Morphed_SemLoc_Concrete_PhaseLocking_AlphaBeta_150_350_' + label_name[0:-3]
		stc_cncrt16 = mne.read_source_estimate(fname_cncrt16)

	### Abstract
		
		fname_abs1 = data_path + ll[1] + 'Morphed_SemLoc_Abstract_PhaseLocking_AlphaBeta_150_350_' + label_name[0:-3]
		stc_abs1 = mne.read_source_estimate(fname_abs1)

		fname_abs2 = data_path + ll[2] + 'Morphed_SemLoc_Abstract_PhaseLocking_AlphaBeta_150_350_' + label_name[0:-3]
		stc_abs2 = mne.read_source_estimate(fname_abs2)

		fname_abs3 = data_path + ll[3] + 'Morphed_SemLoc_Abstract_PhaseLocking_AlphaBeta_150_350_' + label_name[0:-3]
		stc_abs3 = mne.read_source_estimate(fname_abs3)

		fname_abs4 = data_path + ll[4] + 'Morphed_SemLoc_Abstract_PhaseLocking_AlphaBeta_150_350_' + label_name[0:-3]
		stc_abs4 = mne.read_source_estimate(fname_abs4)

		fname_abs5 = data_path + ll[5] + 'Morphed_SemLoc_Abstract_PhaseLocking_AlphaBeta_150_350_' + label_name[0:-3]
		stc_abs5 = mne.read_source_estimate(fname_abs5)

		fname_abs6 = data_path + ll[6] + 'Morphed_SemLoc_Abstract_PhaseLocking_AlphaBeta_150_350_' + label_name[0:-3]
		stc_abs6 = mne.read_source_estimate(fname_abs6)

		fname_abs7 = data_path + ll[7] + 'Morphed_SemLoc_Abstract_PhaseLocking_AlphaBeta_150_350_' + label_name[0:-3]
		stc_abs7 = mne.read_source_estimate(fname_abs7)

		fname_abs8 = data_path + ll[8] + 'Morphed_SemLoc_Abstract_PhaseLocking_AlphaBeta_150_350_' + label_name[0:-3]
		stc_abs8 = mne.read_source_estimate(fname_abs8)

		fname_abs9 = data_path + ll[9] + 'Morphed_SemLoc_Abstract_PhaseLocking_AlphaBeta_150_350_' + label_name[0:-3]
		stc_abs9 = mne.read_source_estimate(fname_abs9)

		fname_abs10 = data_path + ll[10] + 'Morphed_SemLoc_Abstract_PhaseLocking_AlphaBeta_150_350_' + label_name[0:-3]
		stc_abs10 = mne.read_source_estimate(fname_abs10)

		fname_abs11 = data_path + ll[11] + 'Morphed_SemLoc_Abstract_PhaseLocking_AlphaBeta_150_350_' + label_name[0:-3]
		stc_abs11 = mne.read_source_estimate(fname_abs11)

		fname_abs12 = data_path + ll[12] + 'Morphed_SemLoc_Abstract_PhaseLocking_AlphaBeta_150_350_' + label_name[0:-3]
		stc_abs12 = mne.read_source_estimate(fname_abs12)

		fname_abs13 = data_path + ll[13] + 'Morphed_SemLoc_Abstract_PhaseLocking_AlphaBeta_150_350_' + label_name[0:-3]
		stc_abs13 = mne.read_source_estimate(fname_abs13)

		fname_abs14 = data_path + ll[14] + 'Morphed_SemLoc_Abstract_PhaseLocking_AlphaBeta_150_350_' + label_name[0:-3]
		stc_abs14 = mne.read_source_estimate(fname_abs14)

		fname_abs15 = data_path + ll[15] + 'Morphed_SemLoc_Abstract_PhaseLocking_AlphaBeta_150_350_' + label_name[0:-3]
		stc_abs15 = mne.read_source_estimate(fname_abs15)

		fname_abs16 = data_path + ll[16] + 'Morphed_SemLoc_Abstract_PhaseLocking_AlphaBeta_150_350_' + label_name[0:-3]
...
"""
		out_file1=data_path + 'GrandAverage_SemLoc_Concrete_PhaseLocking_AlphaBeta_150_350_' + label_name[0:-3]
		stcs1 = mne.read_source_estimate(out_file1)
		out_file2=data_path + 'GrandAverage_SemLoc_Abstract_PhaseLocking_AlphaBeta_150_350_' + label_name[0:-3]
		stcs2 = mne.read_source_estimate(out_file2)
		stc_subtract=np.subtract(stcs1,stcs2)
		out_file=data_path + 'GrandAverage_SemLoc_Subtract_PhaseLocking_AlphaBeta_150_350_' + label_name[0:-3]
