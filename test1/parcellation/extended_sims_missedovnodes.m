...
%                     load ('ideal_pval_parc4.mat');
            ...
            load(['/imaging/rf02/parcellation/extended_simulations/funcseeds_avgsims70_offset0_seeds',num2str(nseeds),'_conns',num2str(nconns),'_bothsnrs_extglasser/allovnodes.mat'])
