...
#                actsrc_miss=iar.copy()
                ...
                morphed_labelsall_pre=[labellist_m[jj].morph(subject_from='fsaverage', smooth=1, subject_to=subjects[subject_no], subjects_dir=data_path) for jj in range(len(labellist_m))]
                ...
                fname_split=parc_name[which_parc]+'_extsims_smooth1'
...
#        scipy.io.savemat(this_pathto,{'parc2_connmat':parc1_connmat})
