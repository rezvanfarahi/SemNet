...
for simcnt in ll:
    for nseeds in np.array([3,5,10,15]): #,10,15,20
        print nseeds
#        thissnr=3
...
#                
        ...
        parc0_connmat=np.zeros((parc_len[0],parc_len[0],9,len(subject_inds)))#nconxnconxnmeths,nsubs
        parc1_connmat=np.zeros((parc_len[1],parc_len[1],9,len(subject_inds)))
        parc2_connmat=np.zeros((parc_len[2],parc_len[2],9,len(subject_inds)))
        parc3_connmat=np.zeros((parc_len[3],parc_len[3],9,len(subject_inds)))
        parc4_connmat=np.zeros((parc_len[4],parc_len[4],9,len(subject_inds)))
        n_epochs=40
...
#                    parc0_connmat[:,:,4,cnt]=con_res_realideal2.copy()
                    parc0_connmat[:,:,7,cnt]=lowsnr_con_res2.copy()
                    parc0_connmat[:,:,8,cnt]=lowsnr_con_res_ideal2.copy()
                if which_parc==1:
                    ...
                    parc1_connmat[:,:,7,cnt]=lowsnr_con_res2.copy()
                    parc1_connmat[:,:,8,cnt]=lowsnr_con_res_ideal2.copy()
                if which_parc==2:
                    ...
                    parc2_connmat[:,:,7,cnt]=lowsnr_con_res2.copy()
                    parc2_connmat[:,:,8,cnt]=lowsnr_con_res_ideal2.copy()
                if which_parc==3:
                    ...
                    parc3_connmat[:,:,7,cnt]=lowsnr_con_res2.copy()
                    parc3_connmat[:,:,8,cnt]=lowsnr_con_res_ideal2.copy()
                if which_parc==4:
                    ...
                    parc4_connmat[:,:,7,cnt]=lowsnr_con_res2.copy()
                    parc4_connmat[:,:,8,cnt]=lowsnr_con_res_ideal2.copy()
