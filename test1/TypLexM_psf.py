...
for cnt, meg in enumerate(ll):
	...
	data_out = data_path + meg +  'psf_eegmeg_' +lname
	subject_from = subjects[subject_inds[ii]]
    	subject_to = 'fsaverage'
	morphmat1=mne.compute_morph_matrix(subject_from, subject_to, stc_psf_eegmeg.vertno, vertices_to, subjects_dir=data_path)
	stc_to=stc_psf_eegmeg.morph_precomputed(subject_to,vertices_to,morphmat1, subject_from)
...
out_filet=data_path + 'UVttest_PSF_' +lname 
...
out_filet=data_path + 'GrandAverage_PSF_' +lname 
t_stc.save(out_filet)
