...
for p_threshold in ll:
    ...
    print('Clustering.')
    tail=0
    T_obs, clusters, cluster_p_values, H0 = clu = spatio_temporal_cluster_1samp_test(X, connectivity=connectivity,  threshold=t_threshold, tail=tail, t_power=1)#, max_step=0)#, max_step=0)#spatial_exclude=exclude_ver, 
    ...
    out_file1=out_path + 'ClusterPermutation_abs_firstmorphed_clusterp'+str(p_threshold)[2:]+'_p'+str(p_thresh)[2:]+'_17subj_SemLoc_icaclean_ConcreteAbstract_50_550_100ms_0overlap_tail'+str(tail)
    ...
    out_file2=out_path + 'ClusterPermutation_abs_stepwise_firstmorphed_clusterp'+str(p_threshold)[2:]+'_p'+str(p_thresh)[2:]+'_17subj_SemLoc_icaclean_ConcreteAbstract_50_550_100ms_0overlap_tail'+str(tail)
