...
for cnt1, meg in enumerate(ll):
	...
	stcs_conctrete = apply_inverse_epochs(epochs_concrete, inverse_operator, lambda2, method,
		                    pick_ori="normal", return_generator=True)
	stcs_abstract = apply_inverse_epochs(epochs_abstract, inverse_operator, lambda2, method,
		                    pick_ori="normal", return_generator=True)
	...
	label_ts_concrete = mne.extract_label_time_course(stcs_conctrete, labels, src, mode='mean_flip',
		                                 return_generator=True)
	label_ts_abstract = mne.extract_label_time_course(stcs_abstract, labels, src, mode='mean_flip',
		                                 return_generator=True)
	...
	Dmat[cnt1,:,:]=[cncrt_lhmean,cncrt_rhmean,abs_lhmean,abs_rhmean]
