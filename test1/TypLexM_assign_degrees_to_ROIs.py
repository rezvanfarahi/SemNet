...
for cnt, meg in enumerate(ll):
    ...
    out_file_Xct=data_path + meg + 'firstMorphed_SemLoc_icaclean_degree_proportional_25_pca_ppc_concrete_m500_700_theta'
    Xct_stc.save(out_file_Xct)
    
    out_file_Xca=data_path + meg + 'firstMorphed_SemLoc_icaclean_degree_proportional_25_pca_ppc_concrete_m500_700_alpha'
    Xca_stc.save(out_file_Xca)
    
    out_file_Xcb=data_path + meg + 'firstMorphed_SemLoc_icaclean_degree_proportional_25_pca_ppc_concrete_m500_700_beta'
    Xcb_stc.save(out_file_Xcb)
    
    out_file_Xcg=data_path + meg + 'firstMorphed_SemLoc_icaclean_degree_proportional_25_pca_ppc_concrete_m500_700_gamma'
    Xcg_stc.save(out_file_Xcg)
    
    out_file_Xat=data_path + meg + 'firstMorphed_SemLoc_icaclean_degree_proportional_25_pca_ppc_abstract_m500_700_theta'
    Xat_stc.save(out_file_Xat)
    
    out_file_Xaa=data_path + meg + 'firstMorphed_SemLoc_icaclean_degree_proportional_25_pca_ppc_abstract_m500_700_alpha'
    Xaa_stc.save(out_file_Xaa)
    
    out_file_Xab=data_path + meg + 'firstMorphed_SemLoc_icaclean_degree_proportional_25_pca_ppc_abstract_m500_700_beta'
    Xab_stc.save(out_file_Xab)
    
    out_file_Xag=data_path + meg + 'firstMorphed_SemLoc_icaclean_degree_proportional_25_pca_ppc_abstract_m500_700_gamma'
