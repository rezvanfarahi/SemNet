...
for ii, meg in enumerate(ll):
	print ii
	fname_c = data_path + meg +  'Morphed_SemLoc_icaclean_Concrete_Source_Evoked_meanresampled_50_550_100ms'
	stc_c = mne.read_source_estimate(fname_c)

	fname_a = data_path + meg +  'Morphed_SemLoc_icaclean_Abstract_Source_Evoked_meanresampled_50_550_100ms'
...
out_file=out_path + 'GrandMeanDivRange_SemLoc_icaclean_Subtract_Source_Evoked_meanresampled_50_550_100ms'
...
"""
out_file1=out_path + 'GrandAverage_SemLoc_icaclean_Concrete_Source_Evoked_meanresampled_50_550_100ms'  
stcs1 = mne.read_source_estimate(out_file1)
out_file2=out_path + 'GrandAverage_SemLoc_icaclean_Abstract_Source_Evoked_meanresampled_50_550_100ms' 
stcs2 = mne.read_source_estimate(out_file2)
stc_subtract=np.subtract(stcs1,stcs2)
out_file=out_path + 'GrandAverage_SemLoc_icaclean_Subtract_Source_Evoked_meanresampled_50_550_100ms' 
