...
labellist_hubs=[labelss[ii] for ii in label_index]#[labelss[ii] for ii in label_index]
#print labellist
...
X_list=[np.squeeze(x) for x in np.split(X[:,sonset:,np.array([2,7])], 2, axis=-1)]#np.array([1,3])#ROI3 in cond 1, 2, 3
factor_levels = [2]  # number of levels in each factor
