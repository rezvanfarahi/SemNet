...
inv_fname = 'InvOp_ico5newreg_fft_pnt1_48_clean_ica_gamma_EMEG-inv.fif'#inv_fname = 'InverseOperator_fft_1_48_clean_ica_EMEG-inv.fif'
...
## epoching
    ...
    epochs = mne.Epochs(raw, events, event_ids, tmin, tmax, picks=picks, proj=True, baseline=(None, 0), reject=None,preload=True)
    epochs.drop_epochs(drop_inds)
...
#    mne.epochs.equalize_epoch_counts([epochs_concrete,epochs_abstract], method='mintime')
    ...
    cwt_frequencies = np.arange(30, 48, 1)#np.array([6,10,22,38])#
    ...
    for this_epoch in epochs_list:
        ...
        data_out = data_path + meg + 'mineMorphed_bandnoisecov_ico_SemDec_ica_'+event_names[this_event]+'_Power_normori_ratio_equalized_m500_700_200hz_' + b
        cp_stc.save(data_out)
        data_out = data_path + meg + 'mineMorphed_bandnoisecov_ico_SemDec_ica_'+event_names[this_event]+'_rPLV_normori_ratio_equalized_m500_700_200hz_' + b
        ...
        data_out = data_path + meg + 'mineMorphed_bandnoisecov_ico_SemDec_ica_'+event_names[this_event]+'_Power_Even_normori_ratio_equalized_m500_700_200hz_' + b
        cpe_stc.save(data_out)
        data_out = data_path + meg + 'mineMorphed_bandnoisecov_ico_SemDec_ica_'+event_names[this_event]+'_rPLV_Even_normori_ratio_equalized_m500_700_200hz_' + b
        ...
        data_out = data_path + meg + 'mineMorphed_bandnoisecov_ico_SemDec_ica_'+event_names[this_event]+'_Power_Odd_normori_ratio_equalized_m500_700_200hz_' + b
        cpo_stc.save(data_out)
        data_out = data_path + meg + 'mineMorphed_bandnoisecov_ico_SemDec_ica_'+event_names[this_event]+'_rPLV_Odd_normori_ratio_equalized_m500_700_200hz_' + b
