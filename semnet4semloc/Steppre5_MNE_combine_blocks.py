...
for index, meg in enumerate(ll):
   ...
   raw_fname1 = data_path+meg+'block_fruit_tsss_filtSL_1_48_ica_raw.fif'#directory + 'semloc_ssstf_fft_1_30_clean_ica_raw.fif'
   raw1 = mne.io.Raw(raw_fname1, preload=True)
   raw_fname2 = data_path+meg+'block_milk_tsss_filtSL_1_48_ica_raw.fif'#directory + 'semloc_ssstf_fft_1_30_clean_ica_raw.fif'
   raw2 = mne.io.Raw(raw_fname2, preload=True)
   raw_fname3 = data_path+meg+'block_odour_tsss_filtSL_1_48_ica_raw.fif'#directory + 'semloc_ssstf_fft_1_30_clean_ica_raw.fif'
   raw3 = mne.io.Raw(raw_fname3, preload=True)

   print ("Reading events: "+raw_fname3) 
   ...
   raw_fname = data_path+meg+'SemDec_blocks_tsss_filtSL_1_48_ica_raw.fif'
...
#   print (len(epochs)/450.)
   ...
   mne.write_events(raw_fname[:-4]+'-eve.fif', eventsch)
