...
outpath_anova='/imaging/rf02/Semnet/semnet4semloc/dcm/SemNet_SD_500wins_unsigned.mat';
...
for ii=1:ntimewins
    Datafm=squeeze(mean((Dataf(:,(150+1*(ii-1))/q:(150+1*ii)/q,:,:)),2));%5x2x17
