...
'UVttest_rmANOVA_Evoked_icomorphed_oldreg_18subj_SDvsLD_contrast' \
'UVttest_rmANOVA_Evoked_icomorphed_oldreg_18subj_SDvsLD_interaction' \
'UVttest_rmANOVA_Evoked_icomorphed_oldreg_18subj_SDvsLD_task' \
